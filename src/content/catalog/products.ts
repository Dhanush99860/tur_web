...
const europeanIronmongeryProducts: Product[] = [
  ...
  defineEuropeanIronmongeryProduct({
    ...
    ...europeanRoute.control,
    description:
      "Project Series rack and pinion door closer with standard arm — commercial-grade surface mount closer for project-specification applications requiring adjustable closing force and consistent operation.",
    shortDescription: "Project Series rack and pinion door closer with standard arm.",
    overview:
      "The Project Series rack and pinion door closer with standard arm provides a commercial-grade surface-mount closing solution for project-specification and institutional applications. Adjustable closing and latching speed, selectable power size and non-handed installation make it adaptable across a wide range of single-action door openings.",
    ...
    features: [
      "Project-grade rack and pinion mechanism for commercial applications.",
      "Adjustable closing and latching speed.",
      "Selectable power size for different door weights and widths.",
      "Non-handed installation for flexible site conditions.",
      "Surface mount standard arm mechanism.",
      "Back check available upon request.",
    ],
    applications: [
      "Project-specification commercial door sets",
      "Institutional and office interiors",
      "Standard door mount on pull side",
      "Transom mount on push side",
      "Single-action door openings",
    ],
    finishOptions: [
    ...
    specs: [
      ...
      { label: "Arm type", value: "Standard arm" },
      { label: "Mount", value: "Surface mount" },
      { label: "Power size", value: "Adjustable" },
    ],
    howToOrder: "Brand Identity · Model No · Power Size · Type · Finish",
  ...
  defineEuropeanIronmongeryProduct({
    ...
    ...europeanRoute.control,
    description:
      "Rack and pinion door closer with standard arm — surface mount closer with adjustable closing speed and non-handed installation for standard commercial door applications.",
    shortDescription: "Rack and pinion door closer with standard arm, surface mount.",
    overview:
      "Rack and pinion door closer with standard arm provides reliable closing force for commercial door openings. Adjustable closing and latching speed, non-handed installation and compatibility with standard arm accessories make this closer adaptable for a broad range of single-action interior and exterior applications.",
    ...
    features: [
      "Rack and pinion mechanism for consistent closing action.",
      "Adjustable closing and latching speed.",
      "Non-handed installation for flexible site use.",
      "Surface mount standard arm.",
      "Compatible with hold-open arm and parallel bracket accessories.",
    ],
    applications: [
      "Commercial interior door sets",
      "Standard door mount on pull side",
      "Transom mount on push side",
      "Single-action door openings",
    ],
    finishOptions: ["Painted silver (standard)", "Other finishes upon request"],
    specs: [
      { label: "Mechanism", value: "Rack and pinion" },
      { label: "Arm type", value: "Standard arm" },
      { label: "Mount", value: "Surface mount" },
  ...
  defineEuropeanIronmongeryProduct({
    ...
    ...europeanRoute.control,
    description:
      "Rack and pinion door closer with track arm — allows parallel arm installation on the push side of the door without a separate parallel bracket, providing a cleaner visual profile.",
    shortDescription: "Rack and pinion door closer with track arm for push-side installation.",
    overview:
      "The rack and pinion door closer with track arm provides an integrated parallel-arm installation option — the track arm slides along a rail to deliver smooth, controlled closing without the visual bulk of a separate parallel bracket. Suitable for both pull-side and push-side applications on single-action commercial doors.",
    ...
    features: [
      "Track arm mechanism for integrated push-side installation.",
      "Cleaner visual profile — no separate parallel bracket required.",
      "Adjustable closing and latching speed.",
      "Non-handed installation.",
      "Suitable for single-action commercial doors.",
    ],
    applications: [
      "Push-side applications where parallel arm configuration is needed",
      "Commercial interior and exterior door sets",
      "Office and institutional interiors",
    ],
    finishOptions: ["Painted silver (standard)", "Other finishes upon request"],
    specs: [
      { label: "Mechanism", value: "Rack and pinion" },
      { label: "Arm type", value: "Track arm" },
      { label: "Mount", value: "Surface mount" },
    ],
    howToOrder: "Brand Identity · Model No · Power Size · Type · Finish",
  ...
  defineEuropeanIronmongeryProduct({
    ...
    ...europeanRoute.control,
    description:
      "Rack and pinion door closer with standard arm — alternative configuration with adjustable power size and thermo-constant valve for consistent performance across temperature variations.",
    shortDescription: "Rack and pinion door closer with standard arm and thermo-constant valve.",
    overview:
      "This rack and pinion door closer with standard arm incorporates a thermo-constant valve to maintain consistent closing force across a wide temperature range. Suitable for entrances subject to temperature extremes, including building perimeter doors and corridors with significant seasonal variation.",
    ...
    features: [
      "Rack and pinion mechanism with standard arm.",
      "Thermo-constant valve for consistent performance across temperature variations.",
      "Adjustable closing and latching speed.",
      "Non-handed installation.",
      "Surface mount.",
    ],
    applications: [
      "Entrances subject to temperature variation",
      "Commercial exterior and perimeter doors",
      "Standard door mount on pull side",
    ],
    finishOptions: ["Painted silver (standard)", "Other finishes upon request"],
    specs: [
      ...
      { label: "Arm type", value: "Standard arm" },
      { label: "Mount", value: "Surface mount" },
      { label: "Valve", value: "Thermo-constant" },
    ],
    howToOrder: "Brand Identity · Model No · Power Size · Type · Finish",
  ...
  defineEuropeanIronmongeryProduct({
    ...
    ...europeanRoute.control,
    description:
      "TE7792G EN Standard Door Closer with cam action system — cam action mechanism provides significantly lower opening resistance than rack and pinion, meeting EN 1154 accessibility requirements.",
    shortDescription: "TE7792G EN-classified cam action door closer with low opening resistance.",
    overview:
      "The TE7792G cam action door closer delivers a low opening resistance compared to conventional rack and pinion closers — making it the preferred solution for accessibility-compliant door sets. The cam action mechanism generates most of its closing force in the final stages of door travel, reducing the effort required to open the door while ensuring consistent latching. EN 1154 classified.",
    ...
    features: [
      "Cam action mechanism — low opening resistance for accessibility compliance.",
      "Most closing force generated in the final stages of door travel for reliable latching.",
      "EN 1154 classified door closer.",
      "Adjustable closing and latching speed.",
      "Non-handed installation.",
      "Surface mount with standard or track arm configurations.",
    ],
    applications: [
      "Accessibility-compliant commercial door sets",
      "Public buildings and institutional interiors",
      "Healthcare and education facilities",
      "Standard door mount on pull side",
    ],
    finishOptions: ["Silver (standard)", "Other finishes upon request"],
    specs: [
      { label: "Model No", value: "TE7792G" },
      { label: "Mechanism", value: "Cam action" },
      { label: "Classification", value: "EN 1154" },
      { label: "Mount", value: "Surface mount" },
    ],
    howToOrder: "Brand Identity · Model No · Power Size · Type · Arm · Finish",
  ...
  defineEuropeanIronmongeryProduct({
    ...
    ...europeanRoute.secure,
    description:
      "TE1500 Series Classroom Lock — mortise lock designed for educational facilities with classroom function: key from outside controls the lock, free lever egress from inside at all times.",
    shortDescription: "TE1500 classroom lock with key-outside, free-egress-inside function.",
    overview:
      "The TE1500 Series Classroom Lock provides the standard classroom security function — the latch bolt can be held retracted from the outside by key, while the inside lever handle always allows free egress without a key. This configuration supports lockdown procedures in educational environments while maintaining life-safety compliance.",
    ...
    imageAlt: "TE1500 Series classroom mortise lock",
    features: [
      "Classroom function: key from outside controls locking, free lever egress from inside.",
      "Supports emergency lockdown procedures in educational environments.",
      "Life-safety compliant — inside lever always allows free egress.",
      "Euro profile cylinder entry from outside.",
      "Heavy-duty mortise body for long service life.",
    ],
    applications: [
      "School and college classrooms",
      "Educational facility corridors",
      "Institutional rooms requiring controlled access",
    ],
    finishOptions: ["US26D / 626 (satin chrome)", "US32D / 630 (satin stainless)", "Other finishes upon request"],
    specs: [
      { label: "Series", value: "TE1500" },
      { label: "Function", value: "Classroom — key outside, free egress inside" },
      { label: "Type", value: "Mortise lock" },
      { label: "Cylinder", value: "Euro profile" },
    ],
    howToOrder: "Brand Identity · Model No · Function · Handing · Finish",
  ...
  defineEuropeanIronmongeryProduct({
    ...
    ...europeanRoute.secure,
    description:
      "TE1500 Series Mortise X-Ray Lock — non-ferrous mortise lock for medical imaging rooms, constructed without ferrous materials to prevent interference with X-ray and MRI equipment.",
    shortDescription: "TE1500 non-ferrous mortise lock for X-ray and imaging room applications.",
    overview:
      "The TE1500 Series Mortise X-Ray Lock is constructed with non-ferrous, non-magnetic materials throughout — ensuring no interference with X-ray, MRI or other medical imaging equipment in the vicinity. Standard in hospitals, radiology departments and specialist medical facilities requiring both controlled access and imaging-equipment compatibility.",
    ...
    imageAlt: "TE1500 Series mortise X-Ray lock",
    features: [
      "Non-ferrous, non-magnetic construction — no interference with X-ray or MRI equipment.",
      "Standard mortise lock body in non-ferrous materials.",
      "Compatible with standard euro profile cylinder entry.",
      "Suitable for hospitals, radiology departments and imaging suites.",
      "Meets requirements for magnetically sensitive medical environments.",
    ],
    applications: [
      "Hospital radiology and X-ray departments",
      "MRI suites",
      "Medical imaging rooms",
      "Specialist clinical facilities",
    ],
    finishOptions: ["Non-ferrous finishes standard", "Consult factory for specific requirements"],
    specs: [
      { label: "Series", value: "TE1500" },
      { label: "Type", value: "Mortise X-Ray lock" },
      { label: "Material", value: "Non-ferrous, non-magnetic" },
      { label: "Application", value: "Medical imaging environments" },
    ],
    howToOrder: "Brand Identity · Model No · Function · Handing · Finish",
  ...
  defineEuropeanIronmongeryProduct({
    ...
    ...europeanRoute.cylinders,
    description:
      "TE3700 Euro Profile Cylinders — high-security brass cylinders with 6-pin mechanism, master key capability and optional anti-drill protection for demanding commercial and institutional keying systems.",
    shortDescription: "TE3700 high-security Euro profile cylinder with 6-pin mechanism.",
    overview:
      "The TE3700 Series Euro Profile Cylinders deliver enhanced security over standard 5-pin cylinders with a 6-pin tumbler mechanism, increased key combinations and optional master key / master suite configuration. Constructed in precision-machined brass with available anti-drill pins for improved attack resistance. Meets BS EN1303:2005 requirements.",
    ...
    features: [
      "6-pin tumbler mechanism for increased key combinations and higher security.",
      "Master key and master suite configuration available.",
      "Precision-machined brass construction.",
      "Optional anti-drill pin protection.",
      "Meets BS EN1303:2005 requirements.",
      "Double opening by keys.",
    ],
    applications: [
      "Commercial door sets requiring master key systems",
      "Institutional facilities with keyed-alike or keyed-different requirements",
      "Euro profile cylinder door hardware",
    ],
    finishOptions: ["Satin", "Polished", "Other finishes upon request"],
    specs: [
      { label: "Series", value: "TE3700" },
      { label: "Pin count", value: "6 pins" },
      { label: "Profile", value: "Euro profile (DIN 18252)" },
      { label: "Material", value: "Precision-machined brass" },
      { label: "Standard", value: "BS EN1303:2005" },
    ],
    howToOrder: "Brand Identity · Model No · Pin · Type · Length · Finish",
  ...
  defineEuropeanIronmongeryProduct({
    ...
    ...europeanRoute.bolt,
    description:
      "Lever action flush bolt for the inactive leaf of a pair of doors — lever-operated bolt shoots into the head and/or floor to secure the inactive leaf in open and closed positions.",
    shortDescription: "Lever-operated flush bolt for inactive door leaf, head and floor shooting.",
    overview:
      "The lever action flush bolt is mortised into the edge of the inactive leaf of a pair of doors. A simple lever action shoots the bolt into the head frame and/or floor socket, securing the inactive leaf independently of the active leaf latch. Available in various lengths to suit different door heights.",
    ...
    imageAlt: "Lever action flush bolt for inactive door leaf",
    features: [
      "Lever-operated bolt for simple one-handed operation.",
      "Mortised into the edge of the door — minimal visual profile.",
      "Suitable for top (head) and bottom (floor) installation.",
      "For use on the inactive leaf of a pair of doors.",
      "Available in various bolt lengths to suit different frame heights.",
    ],
    applications: [
      "Inactive leaf of paired door sets",
      "Double door configurations in commercial environments",
      "Timber, aluminium and steel door pairs",
    ],
    finishOptions: ["Satin stainless steel", "Polished stainless steel", "Other finishes upon request"],
    specs: [
      { label: "Operation", value: "Lever action" },
      { label: "Installation", value: "Mortised into door edge" },
      { label: "Application", value: "Inactive leaf — head and/or floor" },
    ],
    howToOrder: "Brand Identity · Model No · Length · Finish",
  ...
  defineEuropeanIronmongeryProduct({
    ...
    ...europeanRoute.bolt,
    description:
      "Lever action flush bolt — alternative bolt configuration for inactive leaf applications with varied barrel or lever geometry to suit different door construction requirements.",
    shortDescription: "Alternative lever-operated flush bolt for inactive door leaf.",
    overview:
      "This lever action flush bolt variant provides an alternative barrel length or lever configuration compared to the standard model — suited to door constructions with different edge preparation requirements or where a different lever position is preferred for operational convenience.",
    ...
    imageAlt: "Lever action flush bolt variant for inactive door leaf",
    features: [
      "Lever-operated flush bolt for inactive leaf application.",
      "Alternative configuration — different barrel length or lever geometry.",
      "Mortised into door edge for minimal profile.",
      "Suitable for top and/or floor installation.",
    ],
    applications: [
      "Inactive leaf of paired door sets",
      "Double door configurations requiring alternative bolt dimensions",
    ],
    finishOptions: ["Satin stainless steel", "Polished stainless steel", "Other finishes upon request"],
    specs: [
      { label: "Operation", value: "Lever action" },
  ...
  defineEuropeanIronmongeryProduct({
    ...
    ...europeanRoute.bolt,
    description:
      "Automatic flush bolt for wood door inactive leaf — spring-loaded bolt automatically shoots when the door closes, eliminating the need for manual operation to secure the inactive leaf.",
    shortDescription: "Spring-loaded automatic flush bolt for wood door inactive leaf.",
    overview:
      "The automatic flush bolt for wood doors incorporates a spring-loaded mechanism that automatically extends the bolt into the head frame and/or floor socket as the door closes — no manual lever operation required. Designed for wood door pairs where ease of operation and consistent security of the inactive leaf are required.",
    ...
    imageAlt: "Automatic flush bolt for wood door inactive leaf",
    features: [
      "Spring-loaded automatic operation — bolt shoots when door closes.",
      "No manual lever action required for securing.",
      "Designed for wood door construction.",
      "Suitable for top and/or floor installation.",
      "Release lever retracts bolt for opening the inactive leaf.",
    ],
    applications: [
      "Inactive leaf of wood door pairs",
      "Commercial and institutional wood double doors",
      "Situations where fully automatic bolt operation is preferred",
    ],
    finishOptions: ["Satin stainless steel", "Polished stainless steel", "Other finishes upon request"],
    specs: [
      { label: "Operation", value: "Automatic (spring-loaded)" },
      { label: "Material", value: "For wood door construction" },
      { label: "Installation", value: "Mortised into door edge" },
      { label: "Application", value: "Inactive leaf — head and/or floor" },
    ],
    howToOrder: "Brand Identity · Model No · Length · Finish",
  ...
  defineEuropeanIronmongeryProduct({
    ...
    ...europeanRoute.bolt,
    description:
      "Dust proof strike for floor sockets — self-wiping cover flap prevents dust and debris from accumulating in the floor socket of a vertical rod bolt, maintaining function in high-traffic environments.",
    shortDescription: "Floor strike with dust-excluding flap for vertical rod bolt floor sockets.",
    overview:
      "The dust proof strike is a floor-recessed receiving component for vertical rod and flush bolt systems. A spring-loaded self-closing flap covers the socket opening when the bolt is retracted — preventing dust, dirt and debris from accumulating in the recess. When the bolt is extended (door secured), the flap is pushed aside by the bolt itself, providing clean and reliable engagement.",
    ...
    imageAlt: "Dust proof floor strike for vertical rod bolt",
    features: [
      "Self-closing dust-excluding flap covers socket when bolt is retracted.",
      "Prevents dust and debris accumulation in floor recess.",
      "Suitable for use with vertical rod and flush bolt systems.",
      "Floor-recessed installation — flush with finished floor level.",
      "Maintains bolt engagement reliability in high-traffic environments.",
    ],
    applications: [
      "Paired door sets with vertical rod or flush bolt systems",
      "High-traffic commercial floors",
      "Tiled, concrete and hard floor environments",
    ],
    finishOptions: ["Satin stainless steel", "Other finishes upon request"],
    specs: [
      { label: "Type", value: "Dust proof floor strike" },
      { label: "Flap", value: "Spring-loaded self-closing dust cover" },
      { label: "Installation", value: "Flush floor recessed" },
      { label: "Compatibility", value: "Vertical rod and flush bolt systems" },
    ],
  ...
  defineEuropeanIronmongeryProduct({
    id: 215,
    slug: "door-stop-european",
    title: "Door Stop",
    ...europeanRoute.ancillary,
    description: "Heavy-duty door stop in stainless steel — floor or wall mounted, prevents door from striking walls or furniture and protects decorative surfaces and ironmongery.",
    shortDescription: "Heavy-duty stainless steel door stop, floor or wall mount.",
    overview: "Heavy-duty door stops in stainless steel construction for commercial and institutional applications. Available in floor-mounted, wall-mounted and hinge-mounted configurations to suit different door opening conditions and floor finishes.",
    imageFilename: "default-475192325201108.jpg",
    imagePath: europeanIronmongeryImage("ancillary-products/door-stop-european/door-stop-european-main.jpg"),
    imageAlt: "Heavy-duty stainless steel door stop",
    features: ["Heavy-duty stainless steel construction.", "Floor, wall and hinge-mount configurations available.", "Protects walls, furniture and ironmongery from door impact.", "Rubber buffer tip absorbs impact energy."],
    applications: ["Commercial offices", "Institutional corridors", "Hotel and hospitality interiors"],
    finishOptions: ["Satin stainless steel", "Polished stainless steel"],
    inquirySubject: "Door Stop Inquiry",
  }),
  defineEuropeanIronmongeryProduct({
    id: 214,
    slug: "thumb-turn-indicator",
    title: "Thumb Turn Indicator",
    ...europeanRoute.ancillary,
    description: "Thumb turn indicator showing OCCUPIED / VACANT or IN USE / FREE status — for restrooms, meeting rooms and changing rooms where privacy indication is required.",
    shortDescription: "Thumb turn privacy indicator showing occupied/vacant status.",
    overview: "The thumb turn indicator provides a simple visual privacy indication — a thumb-turn or coin-slot mechanism rotates a colour indicator between OCCUPIED/IN USE (red) and VACANT/FREE (green). Suitable for restroom cubicles, meeting rooms and changing areas in commercial and institutional environments.",
    imageFilename: "default-1821303611201108.jpg",
    imagePath: europeanIronmongeryImage("ancillary-products/thumb-turn-indicator/thumb-turn-indicator-main.jpg"),
    imageAlt: "Thumb turn privacy indicator — occupied/vacant",
    features: ["Colour indicator: red (occupied) / green (vacant).", "Coin-slot or thumb-turn operation.", "Suitable for restrooms, meeting rooms and changing areas.", "Stainless steel housing."],
    applications: ["Restroom cubicles", "Meeting and interview rooms", "Changing and shower rooms"],
    finishOptions: ["Satin stainless steel", "Polished stainless steel"],
    inquirySubject: "Thumb Turn Indicator Inquiry",
  }),
  defineEuropeanIronmongeryProduct({
    id: 213,
    slug: "door-guard",
    title: "Door Guard",
    ...europeanRoute.ancillary,
    description: "Security door guard (chain guard) for residential and light commercial applications — allows the door to be opened a few inches for visual verification of a visitor before releasing.",
    shortDescription: "Security chain door guard for visual verification before opening.",
    overview: "The door guard is a surface-mounted chain or bar device that limits how far a door can be opened from the outside. The occupant can verify a caller and hold a brief conversation with the door partially open before deciding to release the guard and admit the visitor. For residential and light commercial applications.",
    imageFilename: "default-1131835947201108.jpg",
    imagePath: europeanIronmongeryImage("ancillary-products/door-guard/door-guard-main.jpg"),
    imageAlt: "Security door guard chain",
    features: ["Limits door opening for safe caller identification.", "Surface-mounted installation — no mortise required.", "Chain or bar configuration.", "Stainless steel or brass construction.", "Suitable for residential and light commercial doors."],
    applications: ["Residential entry doors", "Hotel room doors", "Light commercial access points"],
    finishOptions: ["Satin stainless steel", "Polished stainless steel", "Polished brass"],
    inquirySubject: "Door Guard Inquiry",
  }),
  defineEuropeanIronmongeryProduct({
    id: 212,
    slug: "door-holders",
    title: "Door Holders",
    ...europeanRoute.ancillary,
    description: "Floor and wall mounted door holders — hold open doors at a fixed position to assist circulation, ventilation and access, with simple release to return the door to closed.",
    shortDescription: "Floor or wall mounted door holders for holding doors open.",
    overview: "Door holders provide a non-electric solution for holding doors open in a fixed position — a floor-mounted spike engages a rubber bumper on the door, or a wall-mounted hook holds the door at the desired opening angle. Manual release allows the door to swing closed when required.",
    imageFilename: "default-657146935201108.jpg",
    imagePath: europeanIronmongeryImage("ancillary-products/door-holders/door-holders-main.jpg"),
    imageAlt: "Door holder — floor and wall mount",
    features: ["Floor-spike or wall-mount configurations.", "Non-electric — no wiring required.", "Rubber buffer absorbs contact energy.", "Suitable for timber, aluminium and steel doors.", "Simple manual release operation."],
    applications: ["Commercial offices", "Institutional corridors", "Retail and hospitality environments"],
    finishOptions: ["Satin stainless steel", "Polished stainless steel", "Polished brass"],
    inquirySubject: "Door Holders Inquiry",
  }),
  defineEuropeanIronmongeryProduct({
    id: 211,
    slug: "door-viewer-european",
    title: "Door Viewer",
    ...europeanRoute.ancillary,
    description: "Wide-angle door viewer (peephole) for visual identification of callers — 180° or greater field of view, suitable for residential and commercial entrance doors of various thicknesses.",
    shortDescription: "Wide-angle door viewer with 180° field of view.",
    overview: "The door viewer is a compact optical device installed through the door at eye height to provide a wide-angle view of the outside without opening the door. Available with 180° or greater field of view for maximum visibility. Suitable for doors of various thicknesses.",
    imageFilename: "default-1303624194201108.jpg",
    imagePath: europeanIronmongeryImage("ancillary-products/door-viewer-european/door-viewer-european-main.jpg"),
    imageAlt: "Wide-angle door viewer peephole",
    features: ["180° or greater field of view.", "Compact installation through door thickness.", "Brass or stainless steel housing.", "Suitable for various door thicknesses.", "One-way viewing for privacy."],
    applications: ["Residential entry doors", "Hotel room doors", "Commercial entrance doors"],
    finishOptions: ["Polished brass", "Satin stainless steel", "Polished stainless steel"],
    inquirySubject: "Door Viewer Inquiry",
  }),
  defineEuropeanIronmongeryProduct({
    id: 210,
    slug: "escutcheon-european",
    title: "Escutcheon",
    ...europeanRoute.ancillary,
    description: "Decorative escutcheon plates for keyhole and euro profile cylinder protection — protects the door surface and cylinder aperture while providing a finished appearance around the lock entry point.",
    shortDescription: "Decorative escutcheon for keyhole and cylinder protection.",
    overview: "Escutcheons are surface-applied cover plates that frame the keyhole or euro profile cylinder entry on the door face. They protect the door surface from key scratches and wear, and provide a decorative finished appearance. Available for standard keyhole and euro profile cylinder formats.",
    imageFilename: "default-2143359644201108.jpg",
    imagePath: europeanIronmongeryImage("ancillary-products/escutcheon-european/escutcheon-european-main.jpg"),
    imageAlt: "Decorative escutcheon plate",
    features: ["Protects door surface around keyhole and cylinder entry.", "Decorative cover plate for finished appearance.", "Available for standard keyhole and euro profile cylinder formats.", "Stainless steel or brass construction."],
    applications: ["Commercial door sets", "Residential entry doors", "Retrofit cylinder protection"],
    finishOptions: ["Satin stainless steel", "Polished stainless steel", "Polished brass"],
    inquirySubject: "Escutcheon Inquiry",
  }),
  defineEuropeanIronmongeryProduct({
    id: 209,
    slug: "flush-handle",
    title: "Flush Handle",
    ...europeanRoute.ancillary,
    description: "Recessed flush pull handle for sliding and pocket doors — sits flush with the door surface when not in use, providing a minimal visual profile while allowing fingertip pulling action.",
    shortDescription: "Recessed flush pull handle for sliding and pocket doors.",
    overview: "The flush handle is mortised into the door edge or face and sits flush with the surface when not in use — providing a clean, minimal appearance on sliding and pocket doors. A finger recess allows easy gripping and pulling action. Suitable for timber, aluminium and glass-framed door constructions.",
    imageFilename: "default-537298917201108.jpg",
    imagePath: europeanIronmongeryImage("ancillary-products/flush-handle/flush-handle-main.jpg"),
    imageAlt: "Flush pull handle for sliding door",
    features: ["Mortised flush with door surface — minimal visual profile.", "Fingertip recess for easy pulling action.", "Suitable for sliding and pocket door applications.", "Stainless steel construction.", "No projection when door is in use."],
    applications: ["Sliding doors", "Pocket doors", "Concealed door applications", "Cabinet and joinery applications"],
    finishOptions: ["Satin stainless steel", "Polished stainless steel"],
    inquirySubject: "Flush Handle Inquiry",
  }),
  defineEuropeanIronmongeryProduct({
    id: 208,
    slug: "push-plate-european",
    title: "Push Plate",
    ...europeanRoute.ancillary,
    description: "Stainless steel push plate for the push side of commercial doors — protects the door surface from hand marks, wear and cleaning products while providing a clear push action indication.",
    shortDescription: "Stainless steel push plate for door protection and push-side indication.",
    overview: "Push plates are applied to the push side of hinged doors to protect the door surface from hand marks, cleaning chemicals and general wear. The plate provides a clear visual and tactile indication of the push-side for users. Available in standard sizes and custom dimensions.",
    imageFilename: "default-1589710071201108.jpg",
    imagePath: europeanIronmongeryImage("ancillary-products/push-plate-european/push-plate-european-main.jpg"),
    imageAlt: "Stainless steel push plate",
    features: ["Protects door surface from hand marks and wear.", "Clear visual indication of push side.", "Stainless steel Grade 304 or 316 construction.", "Available in standard and custom sizes.", "Countersunk fixing screws."],
    applications: ["Commercial office doors", "Hospital and healthcare doors", "Retail and hospitality push-side applications"],
    finishOptions: ["Satin stainless steel", "Polished stainless steel"],
    inquirySubject: "Push Plate Inquiry",
  }),
  defineEuropeanIronmongeryProduct({
    id: 207,
    slug: "flush-ring-pull-handle",
    title: "Flush Ring Pull Handle",
    ...europeanRoute.ancillary,
    description: "Recessed flush ring pull handle for sliding and panel doors — ring lies flush with the door surface when not in use and lifts up to provide a pull grip, suitable for light to medium duty applications.",
    shortDescription: "Recessed flush ring pull that lies flat when not in use.",
    overview: "The flush ring pull handle provides a fully flush appearance when not in use — the ring sits in a recessed housing and is raised to grip and pull the door or panel. Suitable for sliding doors, access panels and light-duty cabinet applications. Available in various ring sizes.",
    imageFilename: "default-921777569201108.jpg",
    imagePath: europeanIronmongeryImage("ancillary-products/flush-ring-pull-handle/flush-ring-pull-handle-main.jpg"),
    imageAlt: "Flush ring pull handle recessed",
    features: ["Ring lies fully flush with door surface when not in use.", "Raises to provide a secure pull grip.", "Recessed housing — minimal projection.", "Stainless steel construction.", "Light to medium duty applications."],
    applications: ["Sliding doors and panels", "Access hatches and panels", "Light-duty cabinet applications"],
    finishOptions: ["Satin stainless steel", "Polished stainless steel"],
    inquirySubject: "Flush Ring Pull Handle Inquiry",
  }),
  defineEuropeanIronmongeryProduct({
    id: 206,
    slug: "finger-pull",
    title: "Finger Pull",
    ...europeanRoute.ancillary,
    description: "Compact finger pull for sliding doors, cabinet doors and access panels — minimal profile recess accommodates one or two fingers for pulling, suitable where a full handle is impractical.",
    shortDescription: "Compact finger pull for sliding doors and access panels.",
    overview: "The finger pull is a small recessed pull mortised into the door or panel edge. It accommodates one or two fingers for pulling action — providing a grip point where a full handle would be impractical or visually undesirable. Ideal for sliding doors, cabinet doors and access panel applications.",
    imageFilename: "default-622478242201108.jpg",
    imagePath: europeanIronmongeryImage("ancillary-products/finger-pull/finger-pull-main.jpg"),
    imageAlt: "Finger pull for sliding door",
    features: ["Minimal profile — mortised flush into door edge or face.", "One or two-finger pull operation.", "Suitable where full handle is impractical.", "Stainless steel construction.", "Available in single and paired configurations."],
    applications: ["Sliding room dividers", "Cabinet and joinery doors", "Access panels and hatches", "Pocket door edges"],
    finishOptions: ["Satin stainless steel", "Polished stainless steel"],
    inquirySubject: "Finger Pull Inquiry",
  }),
  defineEuropeanIronmongeryProduct({
    id: 205,
    slug: "door-protection-plates-european",
    title: "Door Protection Plates",
    ...europeanRoute.ancillary,
    description: "Stainless steel door protection plates — kick plates and mop plates protecting the lower door panel from trolleys, footwear, cleaning equipment and general wear in high-traffic environments.",
    shortDescription: "Stainless steel kick and mop plates for lower door protection.",
    overview: "Door protection plates are applied to the lower portion of door faces to prevent damage from trolleys, feet, cleaning equipment and general wear. Kick plates protect the bottom 300–400 mm, while mop plates cover a smaller zone. Available in various heights and widths to suit different door dimensions.",
    imageFilename: "default-96432182201108.jpg",
    imagePath: europeanIronmongeryImage("ancillary-products/door-protection-plates-european/door-protection-plates-european-main.jpg"),
    imageAlt: "Stainless steel door kick plate",
    features: ["Protects lower door from trolleys, feet and cleaning equipment.", "Stainless steel Grade 304 or 316 construction.", "Available in kick plate (300–400 mm) and mop plate heights.", "Custom widths available to match door width.", "Countersunk fixing for secure installation."],
    applications: ["Hospital and healthcare corridors", "Commercial kitchens and food service areas", "School and institutional high-traffic corridors", "Retail and hospitality environments"],
    finishOptions: ["Satin stainless steel", "Polished stainless steel"],
    inquirySubject: "Door Protection Plates Inquiry",
  }),
  defineEuropeanIronmongeryProduct({
    id: 204,
    slug: "dust-excluding-floor-socket",
    title: "Dust Excluding Floor Socket",
    ...europeanRoute.ancillary,
    description: "Floor socket with self-closing dust-excluding cover — receives the bolt of a vertical rod or flush bolt system while preventing dust and debris accumulation in the floor recess between uses.",
    shortDescription: "Floor socket with dust-excluding cover for vertical rod bolt systems.",
    overview: "The dust excluding floor socket provides a clean receiving point for vertical rod and flush bolt systems. A spring-loaded self-closing cover seals the socket opening when the bolt is retracted — preventing dust, debris and liquids from entering the floor recess. The bolt displaces the cover when extended. Suitable for high-traffic and cleanable hard floor environments.",
    imageFilename: "default-1668475389201108.jpg",
    imagePath: europeanIronmongeryImage("ancillary-products/dust-excluding-floor-socket/dust-excluding-floor-socket-main.jpg"),
    imageAlt: "Dust excluding floor socket for flush bolt",
    features: ["Spring-loaded self-closing dust cover.", "Prevents dust and debris entering floor recess.", "Bolt displaces cover automatically on extension.", "Flush with finished floor — no trip hazard.", "For vertical rod and flush bolt systems."],
    applications: ["Paired door sets with vertical rod bolts", "Hard floor environments", "High-traffic commercial corridors"],
    finishOptions: ["Satin stainless steel", "Polished stainless steel"],
    inquirySubject: "Dust Excluding Floor Socket Inquiry",
  }),
  defineEuropeanIronmongeryProduct({
    id: 203,
    slug: "easy-clean-floor-socket",
    title: "Easy Clean Floor Socket",
    ...europeanRoute.ancillary,
    description: "Easy-clean floor socket for vertical rod and flush bolt systems — smooth internal profile and accessible design allows thorough cleaning, suited to food service, healthcare and hygiene-critical environments.",
    shortDescription: "Easy-clean floor socket for hygiene-critical bolt installations.",
    overview: "The easy-clean floor socket is designed for environments where frequent, thorough cleaning is a requirement. The smooth internal profile eliminates recesses that can trap dirt, and the socket design allows direct access for cleaning equipment. Suitable for food service, healthcare, catering and other hygiene-sensitive applications.",
    imageFilename: "default-1921769358201108.jpg",
    imagePath: europeanIronmongeryImage("ancillary-products/easy-clean-floor-socket/easy-clean-floor-socket-main.jpg"),
    imageAlt: "Easy clean floor socket",
    features: ["Smooth internal profile — no dirt-trapping recesses.", "Designed for frequent and thorough cleaning access.", "Stainless steel construction resists cleaning chemicals.", "Flush with finished floor level.", "For vertical rod and flush bolt systems."],
    applications: ["Food service and commercial kitchens", "Healthcare and clinical environments", "Cleanroom and sterile area doors", "Hygiene-critical commercial facilities"],
    finishOptions: ["Satin stainless steel", "Polished stainless steel"],
    inquirySubject: "Easy Clean Floor Socket Inquiry",
  }),
  defineEuropeanIronmongeryProduct({
    id: 202,
    slug: "roller-latches-european",
    title: "Roller Latches",
    ...europeanRoute.ancillary,
    description: "Spring-loaded roller or ball latch for light-duty door catch applications — no lever or handle required, door pulls closed and is held by the roller catch mechanism engaging a strike.",
    shortDescription: "Spring-loaded roller latch for light-duty door catch applications.",
    overview: "Roller latches provide a simple, non-handled door catch solution for light-duty interior doors. A spring-loaded ball or roller engages a strike recessed in the door frame when the door is closed — holding it lightly in position without the force of a traditional latch bolt. The door can be opened by pulling with minimal force.",
    imageFilename: "default-682926123201108.jpg",
    imagePath: europeanIronmongeryImage("ancillary-products/roller-latches-european/roller-latches-european-main.jpg"),
    imageAlt: "Spring roller latch",
    features: ["Spring-loaded ball or roller catch mechanism.", "No lever handle required — pull to open.", "Light holding force suitable for internal doors.", "Surface or mortise installation options.", "Suitable for cabinet and light room divider doors."],
    applications: ["Light-duty internal doors", "Cabinet and furniture doors", "Room dividers and screens", "Low-traffic interior openings"],
    finishOptions: ["Satin stainless steel", "Polished brass", "Other finishes upon request"],
  ...
  defineEuropeanIronmongeryProduct({
    ...
    title: "Coat Hook",
    ...europeanRoute.ancillary,
    description: "Wall-mounted coat hook in stainless steel for restroom, changing room, corridor and commercial interior applications — single and double hook configurations available.",
    shortDescription: "Stainless steel wall-mounted coat hook, single or double.",
    overview: "Wall-mounted coat hooks in stainless steel construction for commercial and institutional environments. Available in single and double hook configurations, with fixing plate for secure wall installation. Suitable for restrooms, changing rooms, corridors and general commercial interiors.",
    imageFilename: "default-1809187484201108.jpg",
    imagePath: europeanIronmongeryImage("ancillary-products/coat-hook/coat-hook-main.jpg"),
    imageAlt: "Stainless steel coat hook",
    features: ["Stainless steel construction for durability and hygiene.", "Single and double hook configurations.", "Fixing plate for secure wall installation.", "Suitable for high-traffic commercial environments.", "Available in satin and polished finishes."],
    applications: ["Commercial restrooms", "Changing and shower rooms", "Office and institutional corridors", "Hospitality and hotel interiors"],
    finishOptions: ["Satin stainless steel", "Polished stainless steel"],
    inquirySubject: "Coat Hook Inquiry",
  }),
  defineEuropeanIronmongeryProduct({
    id: 200,
    slug: "sign-plates",
    title: "Sign Plates",
    ...europeanRoute.ancillary,
    description: "Standard door sign plates for room identification — available in common configurations including toilet, staff only, meeting room and office designations, for commercial and institutional applications.",
    shortDescription: "Standard door sign plates for room identification.",
    overview: "Sign plates provide clear room and function identification for commercial and institutional environments. Standard configurations include restroom, staff only, meeting room and general office designations. Available in stainless steel with engraved or applied text/symbols, to coordinate with wider ironmongery specification.",
    imageFilename: "default-1216978138201108.jpg",
    imagePath: europeanIronmongeryImage("ancillary-products/sign-plates/sign-plates-main.jpg"),
    imageAlt: "Door sign plate",
    features: ["Standard room identification configurations.", "Engraved or applied text and pictograms.", "Stainless steel construction for durability.", "Available in standard sizes — typically 150 × 50 mm.", "Coordinates with wider European Ironmongery range."],
    applications: ["Commercial offices", "Institutional and healthcare facilities", "Hotels and hospitality", "Educational buildings"],
    finishOptions: ["Satin stainless steel", "Polished stainless steel"],
    inquirySubject: "Sign Plates Inquiry",
  }),
  defineEuropeanIronmongeryProduct({
    id: 199,
    slug: "special-sign-plates",
    title: "Special Sign Plates",
    ...europeanRoute.ancillary,
    description: "Special and bespoke sign plates with custom text, Braille, pictograms and accessibility symbols — for projects requiring non-standard room identification, wayfinding compliance or custom branding.",
    shortDescription: "Custom and Braille sign plates for bespoke wayfinding requirements.",
    overview: "Special sign plates cover non-standard room identification requirements — including Braille tactile text for accessibility compliance, custom pictograms, bespoke text and logo-integrated designs. Available to special order for project-specific wayfinding, accessibility regulations and brand-coordinated interior schemes.",
    imageFilename: "default-1639005195201108.jpg",
    imagePath: europeanIronmongeryImage("ancillary-products/special-sign-plates/special-sign-plates-main.jpg"),
    imageAlt: "Special sign plate with Braille",
    features: ["Custom text, pictograms and branding to project requirement.", "Braille tactile text for accessibility compliance.", "Non-standard sizes and formats available to special order.", "Stainless steel, brass or alternative substrates.", "Coordinates with wider European Ironmongery specification."],
    applications: ["Accessibility compliance wayfinding", "Custom interior branding schemes", "Healthcare and institutional navigation", "Education and public building signage"],
    finishOptions: ["Satin stainless steel", "Polished stainless steel", "Brass and custom substrates on request"],
    inquirySubject: "Special Sign Plates Inquiry",
  }),
  ...[
...
export const products: Product[] = [
  ...
  defineProduct({
    ...
    familyTitle: "American Standard",
    category: "American Standard",
    description: "Manual, automatic and constant-latching flush bolts for inactive leaves in paired door sets. All TÜR flush bolt models are UL Listed for fire-rated assemblies and certified to ANSI/BHMA A156.3.",
    shortDescription: "Manual and automatic flush bolts for metal and wood doors — UL Listed, fire rated, US26D and US32D finishes.",
    overview: "The American Standard Bolt The Door range covers manual flush bolts (TU8401MD for metal doors, TU8401WD for wood doors), constant latching flush bolts (TU8610MD/WD), self-latching flush bolts (TU8510MD/WD) and dust proof strikes (TU8410/TU8412). Manual bolts operate on the inactive leaf in paired openings; automatic bolts engage and latch when the door closes without operator action. All models are available in US26D (626) and US32D (630) finishes. Dust proof strikes are supplied in US26D (626).",
    image: "/tur/home/slider-2.webp",
    imageAlt: "American Standard flush bolt hardware for inactive leaf door sets",
    gallery: gallery("/tur/home/slider-2.webp"),
    features: [
      "TU8401MD — Manual Flush Bolt for Metal Door: brass, 1\" × 6¾\" face, ½\" bolt throw, UL Listed 3-hour fire rated.",
      "TU8401WD — Manual Flush Bolt for Wood Door: brass/stainless steel, 1\" × 8½\" face, 19mm bolt throw, UL Listed 1½-hour fire rated.",
      "TU8610MD/WD — Constant Latching Flush Bolt: automatic operation, engages inactive leaf when both leaves are closed, UL Listed 1½-hour fire rated.",
      "TU8510MD/WD — Self Latching Flush Bolt: top bolt auto-engages frame strike on door close; certified cUL/UL Label A (3-hour fire doors), ANSI/BHMA A156.3.",
      "TU8410/TU8412 — Dust Proof Strike: 1\" (25mm) diameter × 2\" (51mm) depth, supplied with or without face plate.",
    ],
    applications: [
      "Inactive leaf in paired door sets",
      "Commercial and institutional double-door openings",
      "Fire-rated paired door assemblies requiring compliant bolting",
      "Paired doors with simultaneous close sequences (self-latching top + automatic bottom)",
    ],
    finishOptions: ["US26D (626) — Satin Chromium Plated", "US32D (630) — Satin Stainless Steel"],
    inquirySubject: "American Standard Bolt The Door Inquiry",
    relatedSlugs: ["american-emergency-exits", "american-furnish-the-door", "hang-the-door"],
  }),
  defineProduct({
    ...
    familyTitle: "American Standard",
    category: "American Standard",
    description: "Supporting hardware that completes coordinated American Standard door sets — floor stops, door holders, roller latches, door coordinators, overhead holders, flush pulls, push plates and door silencers.",
    shortDescription: "Completion hardware for American Standard door sets — stops, holders, latches, coordinators and trim accessories.",
    overview: "The American Standard Ancillary Products range covers the supporting items needed to complete a coordinated door set package. Products include floor stops, door holders, roller latches, door coordinators, surface-mounted door coordinators, overhead holders and stops, security flush pulls, push plates and door silencers. These items work alongside closers, locks and hinges to ensure full operational and specification compliance for the opening.",
    image: "/tur/home/slider-1.webp",
    imageAlt: "American Standard ancillary door hardware — stops, holders and trim accessories",
    gallery: gallery("/tur/home/slider-1.webp"),
    features: [
      "Floor Stops — low-profile floor-mounted door stops for controlling leaf travel.",
      "Door Holders — wall and floor-mounted holders to hold doors in the open position.",
      "Roller Latches — concealed or surface-mounted roller latches for interior door closures.",
      "Door Coordinators — overhead coordinators ensuring inactive leaf closes before active leaf on paired doors.",
      "Surface Mounted Door Coordinator — surface-applied coordinator for paired doors where mortise fitting is not possible.",
      "Overhead Holders & Stops — overhead-mounted combined holder and stop units.",
      "Security Flush Pull — flush-mount pull for single-action operation on sliding or swing doors.",
      "Push Plate — stainless steel push plate for non-latching door protection and operation.",
      "Door Silencer — rubber or nylon silencer to dampen door-close impact noise.",
    ],
    applications: [
      "Commercial office and institutional door sets",
      "Hospitality and healthcare corridor and room doors",
      "Paired door sets requiring coordinated sequenced closing",
      "Interior doors requiring concealed or flush hardware finishing",
    ],
    finishOptions: ["US26D (626) — Satin Chromium", "US32D (630) — Satin Stainless Steel", "US28 (628) — Satin Aluminum"],
    inquirySubject: "American Standard Ancillary Products Inquiry",
    relatedSlugs: ["american-bolt-the-door", "american-emergency-exits", "hang-the-door"],
  }),
  defineProduct({
    ...
    familyTitle: "American Standard",
    category: "American Standard",
    description: "TA9100 Narrow Stile and TA9900 Wide Stile exit device series — UL Listed, ANSI A156.3 Grade 1 certified, fire rated 3 hours. Covers rim, surface vertical rod, less bottom rod, concealed vertical rod, mortise lock and multi-point configurations for standard 36\" door widths with 24\" and 48\" options.",
    shortDescription: "TA9100 Narrow Stile and TA9900 Wide Stile exit devices — UL Listed, ANSI A156.3 Grade 1, fire rated 3 hours.",
    overview: "The American Standard Emergency Exits range is built on the TA9000 Series — heavy-duty exit devices tested and listed by Underwriters Laboratories (UL and cUL) for Panic Exit Hardware and Fire Exit Hardware. All devices meet or exceed ANSI A156.3 Grade 1. The TA9100 Narrow Stile series covers stile widths from 1¾\" (45mm) and the TA9900 Wide Stile series covers stile widths from 4⁷⁄₃₂\" (107mm). Both series offer non-handed or reversible designs, stainless steel latch bolts with ¾\" throw, and standard door widths of 24\", 36\" and 48\". SS316 grade is available on request. The TE9700 Series Project exit device is also available, UL305 and ANSI A156.3 fire rated to 3 hours.",
    image: "/tur/door-hardware/sliding-f.jpg",
    imageAlt: "American Standard TA9000 series exit devices — panic hardware for commercial egress",
    gallery: gallery("/tur/door-hardware/sliding-f.jpg"),
    features: [
      "All devices UL Listed (UL305) and ANSI A156.3 Grade 1 certified — fire rated 3 hours.",
      "Non-handed or reversible design across all configurations.",
      "Stainless steel latch bolt, ¾\" throw on all primary models.",
      "TA9110F — Narrow Stile Rim Exit Device: ½-turn hex key dogging, 900 rigid strike standard.",
      "TA9120F — Narrow Stile Surface Vertical Rod (SVR): top latch ¾\", bottom latch ½\", 720/730 strikes.",
      "TA9120F-LBR — Narrow Stile Less Bottom Rod (LBR): top latch only, 720 top strike.",
      "TA9140F — Narrow Stile Concealed Vertical Rod (CVR): 720C/730C strikes.",
      "TA9130F — Narrow Stile Mortise Lock: 905 mortise strike, stainless steel dead latch bolt.",
      "TA9150F — Narrow Stile Multi-Points (3PTS): 720 top and 730 bottom strikes.",
      "TA9910F — Wide Stile Rim Exit Device: stile width 4⁷⁄₃₂\" (107mm), 900 rigid strike.",
      "TA9920F — Wide Stile SVR and LBR variants.",
      "TA9940F — Wide Stile CVR; TA9930F — Wide Stile Mortise Lock; TA9950F — Wide Stile Multi-Points.",
      "Door thickness 1¾\"–2\" standard; mounting height 41\" from CL to finished floor.",
      "SS316 grade option available on request; powder coat and architectural finishes available.",
    ],
    applications: [
      "Office buildings, retail stores and healthcare facilities",
      "Schools, apartments, multi-family buildings and stadiums",
      "Resort hotels, restaurants and indoor parking",
      "Industrial facilities requiring fire exit compliance",
      "Paired door sets requiring coordinated multi-point egress",
    ],
    finishOptions: ["AL (Aluminum) — standard", "US32D (630) — Satin Stainless Steel — standard", "SS316 Grade — on request", "605, 606, 613, 625, 689 — on request"],
    inquirySubject: "American Standard Emergency Exits Inquiry",
    relatedSlugs: ["american-bolt-the-door", "american-ancillary-products", "hang-the-door"],
  }),
  defineProduct({
    ...
    familyTitle: "American Standard",
    category: "American Standard",
    description: "Stainless Steel Grade 304/316 pull handles in 12 architectural shapes — H, 45H, OD, SDC, OV, SD, OC, HC, D, DC, DS, DQ and PHD. Suitable for glass, timber, aluminium and PVC doors. Available in diameters 19–50mm with bolt-through (BT) and back-to-back (BB) fixing, and standard or custom lengths.",
    shortDescription: "SS304/316 architectural pull handles in 12 shapes — standard and custom sizes, BT/BB fixing, 6 finish options.",
    overview: "The American Standard Furnish The Door range covers the TÜR SS304/316 pull handle programme. All handles mount using M8 bolts for a maximum door thickness of 110mm and are available in singles or pairs. Standard configurations ship with studs and washers. Diameter and maximum recommended length: 19mm up to 1000mm, 25mm up to 1500mm, 32mm up to 2000mm, 38mm up to 2400mm, 50mm up to 2600mm. The range also includes bare pull and pull-with-plate models (TU8006–TU8112 series) in 0.75\" and 1\" diameter at 6\", 8\" and 12\" centre-to-centre spacings, and offset pull models (TU8180). Custom sizes are available on request.",
    image: "/tur/door-hardware/mc-1.jpg",
    imageAlt: "TÜR SS304/316 architectural pull handles — American Standard furnishing hardware",
    gallery: gallery("/tur/door-hardware/mc-1.jpg"),
    features: [
      "12 architectural shapes: H, 45H, OD, SDC, OV, SD, OC, HC (curved), D, DC (curved), DS (square), DQ (square 90°), PHD.",
      "Material: Stainless Steel Grade 304/316 — solid stainless steel fitting throughout.",
      "Suitable for glass, timber, aluminium and PVC doors.",
      "M8 bolt fixing — maximum door thickness 110mm; available in bolt-through (BT) and back-to-back (BB) configurations.",
      "Available in singles and pairs; standard and custom sizes.",
      "Recommended diameter-to-length stability: 19mm/1000mm, 25mm/1500mm, 32mm/2000mm, 38mm/2400mm, 50mm/2600mm.",
      "Bare pull models TU8006–TU8012 (0.75\" and 1\" dia., 6\"/8\"/12\" c/c); pull-with-plate models TU8106–TU8112 (4\" × 16\" plate).",
      "Offset pull models TU8180-1 (0.75\" dia.) and TU8180-2 (1\" dia.) at 6\" c/c.",
    ],
    applications: [
      "Glass and frameless entrance doors",
      "Timber, aluminium and PVC commercial doors",
      "Premium hospitality and corporate lobbies",
      "Retail frontage and high-traffic public entrances",
    ],
    finishOptions: [
    ...
    relatedSlugs: ["american-bolt-the-door", "american-ancillary-products", "american-emergency-exits"],
  }),
  ...
  defineProduct({
    ...
    category: "European Ironmongery",
    description:
      "TU.DB006 and TU.DB014 lever action flush bolts (203×19 / 254×19 / 305×19mm, screw fixing, SS304) plus TU.DB016 automatic flush bolt for wood door inactive leaf — coordinated with the European Ironmongery specification range.",
    shortDescription:
      "Lever action and automatic flush bolts for European ironmongery packages — SS304, screw fixing.",
    overview:
      "Bolt The Door in the European Ironmongery range covers three bolt families. TU.DB006 and TU.DB014 are lever action flush bolts available in three lengths (203×19mm, 254×19mm, 305×19mm) with screw fixing in Satin Stainless Steel. TU.DB016 is an automatic flush bolt for wood door inactive leaves — made from Brass/Stainless Steel, it operates automatically to keep the inactive leaf bolted when both leaves are shut. All models suit paired door openings where a coordinated bolt is required alongside lever handles, cylinders and locks from the same schedule.",
    image: "/tur/door-hardware/mc-1.jpg",
    imageAlt: "Lever action flush bolt — European ironmongery bolt family",
    gallery: gallery("/tur/door-hardware/mc-1.jpg", "/tur/home/project-2.jpg", "/tur/home/slider-1.webp"),
    features: [
      "TU.DB006 Lever Action Flush Bolt — 203×19mm, 254×19mm, 305×19mm; screw fixing; Satin Stainless Steel.",
      "TU.DB014 Lever Action Flush Bolt — 203×19mm, 254×19mm, 305×19mm; screw fixing; Satin Stainless Steel.",
      "TU.DB016 Automatic Flush Bolt for Wood Doors — Brass/Stainless Steel; bolt 19mm; US26D (626) / US32D (630) finish.",
      "TU.DB016 auto-bolts the inactive leaf when both leaves are shut — no manual operation required.",
      "Lever action models: screw-fixing installation, other finishes available upon request.",
    ],
    applications: [
      "Paired door sets requiring coordinated inactive leaf bolting",
      "Premium hospitality and hotel ironmongery packages",
      "Fire door paired openings where inactive leaf must remain bolted",
      "Executive office and institutional double-door sets",
    ],
    finishOptions: [
      "630 — Satin Stainless Steel (standard for DB006 / DB014)",
      "626 — US26D Satin Chrome (DB016)",
      "630 — US32D Stainless Steel (DB016)",
      "Other finishes available upon request",
    ],
  ...
  defineProduct({
    ...
    category: "European Ironmongery",
    description:
      "TE3606 Euro Profile Cylinders (5 or 6 pin) and TE3700 Euro Profile Cylinders (6+3 pin) — both compliant with BS EN 1303:2005, tested to 100,000+ cycles, with master keying potential supporting up to 10,000–15,000 cylinders under a single Grand Master Key.",
    shortDescription:
      "TE3606 (5/6-pin) and TE3700 (6+3-pin) Euro cylinders — BS EN 1303:2005, 100,000+ cycles, full master key system support.",
    overview:
      "The European Ironmongery Cylinders range covers two Euro profile cylinder families. The TE3606 uses a 5 or 6 pin key bitting system offering 30,000 key combinations (KD) and master keying potential for up to 10,000 cylinders under a Grand Master Key. The TE3700 uses a 6+3 pin system providing 100,000+ key combinations and master keying potential for up to 15,000 cylinders. Both models feature brass bodies, brass plugs, self-lubricating DIN sintered steel cams, cemented steel pins, variable shape hardened steel pin drivers, phosphorous bronze and steel springs, and a paracentrical nickel silver key (2.4mm thick, 12mm neck). Available as Single Cylinder (SC), Double Cylinder (DC), Thumb Turn (TT), Single Thumb Turn (ST) and Privacy Cylinder (PC). Compliant with BS EN 1303:2005 and dimensionally to DIN 18252. Standard equipment includes 3 keys and fixing screw.",
    image: "/tur/home/slider-2.webp",
    imageAlt: "TE3606 and TE3700 Euro profile cylinders — European Ironmongery cylinder hardware",
    gallery: gallery("/tur/home/slider-2.webp", "/tur/door-hardware/sliding-a.jpg", "/tur/home/project-a.jpg"),
    features: [
      "TE3606 — 5 or 6 pin key bitting system; 30,000 key combinations (KD); master keying potential for 10,000 cylinders under one Grand Master Key.",
      "TE3700 — 6+3 pin key bitting system; 100,000+ key combinations; master keying potential for 15,000 cylinders; anti-bump, anti-pick and anti-drill protection.",
      "Both models: brass body, brass plugs, self-lubricating DIN sintered steel cam, hardened steel pin drivers.",
      "Tested to 100,000+ cycles; compliant with BS EN 1303:2005 and DIN 18252 (dimensional).",
      "Available types: SC (Single Cylinder), DC (Double Cylinder), TT (Thumb Turn), ST (Single Thumb Turn), PC (Privacy Cylinder).",
      "Lengths: 40mm–130mm in DC/TT configuration, 40–45mm in SC/ST configuration.",
      "Key options: KD (Keyed to Differ), KA (Keyed Alike), MKD (Master Keyed), CK (Central Key).",
      "TE3700 additional: fire rating possibility; anti-bump certification.",
      "Standard supply: 3 keys + fixing screw. Key duplication controlled by Format authorized centres.",
    ],
    applications: [
      "Company headquarters, universities and hospitals requiring master key access management",
      "Public buildings, shopping malls and apartment buildings",
      "Medium-security commercial and institutional openings",
      "Project-wide keyed suite coordination under single or multi-level master key systems",
    ],
    finishOptions: [
      "605 — Polished Brass",
      "606 — Satin Brass",
      ...
      "626 — Satin Chrome",
      "630 — Stainless Steel",
      "SNP — Standard Nickel Plated Brass (standard)",
      "SBR — Sanded Brass (on request)",
    ],
  ...
  defineProduct({
    ...
    category: "European Ironmongery",
    description:
      "TE1910 (Premium Series) and TE1920/TE1930 (Project Series) stainless steel 304 lever and knob handles — BS EN 1906:2012 Grade 4, 200,000 life cycle tested, for wood and metal doors 38–45mm thick. Available in Satin and Polished finishes.",
    shortDescription:
      "TE1910 Premium and TE1920/TE1930 Project Series SS304 lever handles — BS EN 1906:2012 Grade 4, 200,000 cycles.",
    overview:
      "The European Ironmongery Furnish The Door Lever Handle range covers the TE1910 Premium Series and the TE1920/TE1930 Project Series. All handles are constructed from stainless steel 304 round tube (19mm diameter) with a built-in retaining spring. Door thickness range is 38–45mm. Each set is supplied with one pair of lever handles, one pair of escutcheons, one spindle, one hexagon spanner and fixing screws. The Premium Series (TE1910.966, .967, .968, .970) and Project Series (TE1920.964, .966, .967, .968, .970, .971, .975, .977, .910, .911, .912, .914, .916, .938, .939, .955, .96, .134; TE1930.132, .133) offer a wide range of lever designs. Knob handle variants (TE1920.910, .955, .914, .912) are also included. Certification: BS EN 1906:2012 — Grade 4 (200,000 life cycle test). How to order: TE [19] [Series] [Design] [Options] [Finish] — e.g. TE1910.967.630.",
    image: "/tur/home/project-2.jpg",
    imageAlt: "TE1910 and TE1920 lever handles — European Ironmongery furnishing hardware",
    gallery: gallery("/tur/home/project-2.jpg", "/tur/home/project-4.jpg", "/tur/door-hardware/mc-2.jpg"),
    features: [
      "Material: Stainless Steel 304 round tube, 19mm diameter (TE1930 series: solid SS304).",
      "Built-in retaining spring construction — suitable for wood and metal doors.",
      "Door thickness: 38–45mm.",
      "Certification: BS EN 1906:2012 Grade 4 — 200,000 life cycle test.",
      "TE1910 Premium Series: designs .966, .967, .968, .970.",
      "TE1920 Project Series: lever designs .964, .966, .967, .968, .970, .971, .975, .977, .96, .134, .938, .939; knob designs .910, .911, .912, .914, .916, .955.",
      "TE1930 Project Series Solid: designs .132, .133 — adjustable height/length (125–145mm height, 50–65mm L).",
      "Anti-Microbial (AM) and Lead Line (LL) options available upon request.",
      "Standard supply: pair of handles, pair of escutcheons, spindle, hexagon spanner, fixing screws.",
    ],
    applications: [
      "Premium hospitality guestrooms, suites and public areas",
      "Executive offices and boardrooms",
      "Institutional and healthcare door sets requiring Grade 4 durability",
      "High-spec residential common areas",
    ],
    finishOptions: [
      "630 — Satin Stainless Steel (standard)",
      "629 — Bright Stainless Steel",
      "605 — Polished Brass",
      "606 — Satin Brass",
      "Other finishes available upon request",
  ...
  defineProduct({
    ...
    gallery: gallery("/tur/automatic-operators/swing-door-drives/tsw150-automatic-door-operator/tsw150-automatic-door-operator-main.jpg", "/tur/automatic-operators/swing-door-drives/swing-door-drives/swing-door-drives-main.jpg", "/tur/automatic-operators/swing-door-drives/tsw120-automatic-door-operator/tsw120-automatic-door-operator-main.jpg"),
    features: [
      "Low-energy swing door operator for accessibility, hygiene-conscious and mixed-use circulation.",
      "Supports single and double door configurations up to 150 kg door leaf weight.",
      "Compatible with motion detectors, touch-to-open pads, access control and time switch.",
      "Adjustable hold-open time, opening and closing speed.",
      "Obstruction detection with safety reversal function.",
      "Suitable for healthcare, institutional and project-led entrance automation.",
    ],
    applications: ["Healthcare entrances", "Commercial lobbies", "Institutional access routes", "Accessibility-led upgrades"],
    finishOptions: ["Single Door", "Double Door"],
    specs: [
      { label: "Max. door leaf weight", value: "150 kg" },
      { label: "Max. door width", value: "1100 mm" },
      { label: "Hold-open time", value: "0 – 99 s (adjustable)" },
      { label: "Opening speed", value: "up to 0.7 m/s (adjustable)" },
      { label: "Supply voltage", value: "230V AC, 50Hz" },
      { label: "Protection class", value: "IP 44" },
      { label: "Standards", value: "EN 16005, AutSchR" },
    ],
    badge: "Featured",
  ...
  defineProduct({
    ...
    gallery: gallery("/tur/automatic-operators/swing-door-drives/tsw120-automatic-door-operator/tsw120-automatic-door-operator-main.jpg", "/tur/automatic-operators/swing-door-drives/tsw150-automatic-door-operator/tsw150-automatic-door-operator-main.jpg", "/tur/automatic-operators/swing-door-drives/swing-door-drives/swing-door-drives-main.jpg"),
    features: [
      "Automatic swing door operator for quiet, specification-led entrance environments.",
      "Supports single and double door configurations up to 120 kg door leaf weight.",
      "Compatible with motion detectors, push-button activation and access control.",
      "Adjustable opening speed and hold-open time for smooth, quiet operation.",
      "Obstruction detection with safety reversal function.",
      "Suitable for corporate, educational and mixed-use entrance automation.",
    ],
    applications: ["Corporate access routes", "Education schemes", "Mixed-use circulation points", "Accessibility-led upgrades"],
    finishOptions: ["Single Door", "Double Door"],
    specs: [
      { label: "Max. door leaf weight", value: "120 kg" },
      { label: "Max. door width", value: "1000 mm" },
      { label: "Hold-open time", value: "0 – 99 s (adjustable)" },
      { label: "Opening speed", value: "up to 0.7 m/s (adjustable)" },
      { label: "Supply voltage", value: "230V AC, 50Hz" },
      { label: "Protection class", value: "IP 44" },
      { label: "Standards", value: "EN 16005" },
    ],
  ...
  defineProduct({
    ...
    gallery: gallery("/tur/automatic-operators/all-glass-systems/sliding-doors/sliding-doors-main.jpg", "/tur/automatic-operators/all-glass-systems/shopmaster-gsw-m-g30/shopmaster-gsw-m-g30-main.jpg", "/tur/automatic-operators/all-glass-systems/shopmaster-gsw-m/shopmaster-gsw-m-main.jpg"),
    features: [
  ...
  defineProduct({
    ...
    gallery: gallery("/tur/automatic-operators/swing-door-drives/swing-door-drives/swing-door-drives-main.jpg", "/tur/automatic-operators/swing-door-drives/tsw120-automatic-door-operator/tsw120-automatic-door-operator-main.jpg", "/tur/automatic-operators/swing-door-drives/tsw150-automatic-door-operator/tsw150-automatic-door-operator-main.jpg"),
    features: [
  ...
  defineProduct({
    ...
    gallery: gallery("/tur/automatic-operators/sliding-doors/prismatic-sliding-door-cmw/prismatic-sliding-door-cmw-main.png", "/tur/automatic-operators/sliding-doors/curved-sliding-door-cmr/curved-sliding-door-cmr-main.jpg", "/tur/automatic-operators/sliding-doors/telescoping-sliding-door-emt/telescoping-sliding-door-emt-main.jpg"),
    features: [
  ...
  defineProduct({
    ...
    gallery: gallery("/tur/automatic-operators/sliding-doors/curved-sliding-door-cmr/curved-sliding-door-cmr-main.jpg", "/tur/automatic-operators/sliding-doors/prismatic-sliding-door-cmw/prismatic-sliding-door-cmw-main.png", "/tur/automatic-operators/sliding-doors/telescoping-sliding-door-emt/telescoping-sliding-door-emt-main.jpg"),
    features: [
  ...
  defineProduct({
    ...
    gallery: gallery("/tur/automatic-operators/sliding-doors/telescoping-sliding-door-emt/telescoping-sliding-door-emt-main.jpg", "/tur/automatic-operators/sliding-doors/economaster-em/economaster-em-main.jpg", "/tur/automatic-operators/sliding-doors/heavymaster-hm/heavymaster-hm-main.jpg"),
    features: [
  ...
  defineProduct({
    ...
    gallery: gallery("/tur/automatic-operators/sliding-doors/heavymaster-hm/heavymaster-hm-main.jpg", "/tur/automatic-operators/sliding-doors/escape-route-sliding-door-hm-f-ft/escape-route-sliding-door-hm-f-ft-main.jpg", "/tur/automatic-operators/sliding-doors/telescoping-sliding-door-emt/telescoping-sliding-door-emt-main.jpg"),
    features: [
  ...
  defineProduct({
    ...
    gallery: gallery("/tur/automatic-operators/revolving-doors/ggg-all-glass-revolving-door/ggg-all-glass-revolving-door-main.jpg", "/tur/automatic-operators/revolving-doors/gra-standard-revolving-door/gra-standard-revolving-door-main.jpg", "/tur/automatic-operators/revolving-doors/ggr-large-capacity-revolving/ggr-large-capacity-revolving-main.jpg"),
    features: [
      "All-glass wing construction for maximum entrance transparency and architectural clarity.",
      "Smooth quiet rotation suitable for premium hospitality and corporate settings.",
      "3-wing and 4-wing configurations available for different throughput and aesthetic requirements.",
      "Glass panels in 10 – 12 mm toughened laminated glass.",
      "Supports access control integration and safety sensor layers.",
      "Available with LED lighting option for interior ceiling panels.",
    ],
    applications: ["Corporate headquarters", "Premium hotels", "High-end retail flagships", "Luxury hospitality arrivals"],
    finishOptions: ["3-Wing", "4-Wing"],
    specs: [
      { label: "Diameter", value: "1800 – 4000 mm" },
      { label: "Number of wings", value: "3 or 4" },
      { label: "Clear passage width per wing", value: "750 – 1400 mm" },
      { label: "Clear passage height", value: "up to 3000 mm" },
      { label: "Glass thickness", value: "10 – 12 mm toughened laminated" },
      { label: "Supply voltage", value: "230V AC, 50Hz" },
    ],
    badge: "Featured",
  ...
  defineProduct({
    ...
    gallery: gallery("/tur/automatic-operators/revolving-doors/gra-standard-revolving-door/gra-standard-revolving-door-main.jpg", "/tur/automatic-operators/revolving-doors/ggg-all-glass-revolving-door/ggg-all-glass-revolving-door-main.jpg", "/tur/automatic-operators/revolving-doors/gsi-security-revolving-door/gsi-security-revolving-door-main.jpg"),
    features: [
      "Proven automatic revolving platform for consistent entrance performance and visitor throughput.",
      "GRA-F variant with fire-safe breakout for escape and rescue route compliance.",
      "3-wing and 4-wing configurations for different throughput and footprint requirements.",
      "Supports access control integration, safety sensor layers and building management systems.",
      "Suitable for mixed-use, institutional and commercial entrance applications.",
    ],
    applications: ["Office buildings", "Shopping centres", "Airports and transport hubs", "Mixed-use institutional entrances"],
    finishOptions: ["3-Wing", "4-Wing", "Breakout (GRA-F)"],
    specs: [
      { label: "Diameter", value: "2000 – 3500 mm" },
      { label: "Number of wings", value: "3 or 4" },
      { label: "Clear passage width per wing", value: "800 – 1300 mm" },
      { label: "Clear passage height", value: "up to 2900 mm" },
      { label: "Supply voltage", value: "230V AC, 50Hz" },
      { label: "GRA-F variant", value: "Fire-safe breakout for escape route compliance" },
    ],
    technicalDrawings: [
      {
  ...
  defineProduct({
    ...
    gallery: gallery("/tur/automatic-operators/revolving-doors/gsi-security-revolving-door/gsi-security-revolving-door-main.jpg", "/tur/automatic-operators/revolving-doors/ggg-all-glass-revolving-door/ggg-all-glass-revolving-door-main.jpg", "/tur/automatic-operators/revolving-doors/gra-standard-revolving-door/gra-standard-revolving-door-main.jpg"),
    features: [
      "Anti-tailgating single-person passage design for high-security access control.",
      "Integrates with card reader, biometric, PIN and access management systems.",
      "Available in various resistance configurations for government and critical infrastructure.",
    ...
    specs: [
      { label: "Diameter", value: "1400 – 2200 mm" },
      { label: "Number of wings", value: "3" },
      { label: "Passage type", value: "Controlled single-person" },
      { label: "Clear passage width", value: "600 – 800 mm" },
      { label: "Supply voltage", value: "230V AC, 50Hz" },
      { label: "Access control", value: "Card reader, biometric, PIN compatible" },
    ],
  ...
  defineProduct({
    ...
    gallery: gallery("/tur/automatic-operators/controlled-physical-access/turnstile-systems/turnstile-systems-main.jpg", "/tur/automatic-operators/controlled-physical-access/tripod-turnstiles/tripod-turnstiles-main.jpg", "/tur/automatic-operators/controlled-physical-access/full-height-turnstile/full-height-turnstile-main.jpg"),
    features: [
  ...
  defineProduct({
    ...
    image: "/tur/automatic-operators/controlled-physical-access/speed-gate-barriers/speed-gate-barriers-main.jpg",
    imageAlt: "Speed gate barrier system — elegant corporate pedestrian access control",
    gallery: gallery("/tur/automatic-operators/controlled-physical-access/speed-gate-barriers/speed-gate-barriers-main.jpg", "/tur/automatic-operators/controlled-physical-access/turnstile-systems/turnstile-systems-main.jpg", "/tur/automatic-operators/controlled-physical-access/sensor-barriers/sensor-barriers-main.jpg"),
    features: [
  ...
  defineProduct({
    ...
    gallery: gallery("/tur/automatic-operators/controlled-physical-access/full-height-turnstile/full-height-turnstile-main.jpg", "/tur/automatic-operators/controlled-physical-access/turnstile-systems/turnstile-systems-main.jpg", "/tur/automatic-operators/controlled-physical-access/tripod-turnstiles/tripod-turnstiles-main.jpg"),
    features: [
  ...
  defineProduct({
    ...
    gallery: gallery("/tur/automatic-operators/automatic-pulse-generators-and-sensors/activation-devices-sensors/activation-devices-sensors-main.webp", "/tur/automatic-operators/automatic-pulse-generators-and-sensors/safety-sensors/safety-sensors-main.webp", "/tur/automatic-operators/automatic-pulse-generators-and-sensors/control-inputs/control-inputs-main.jpg"),
    features: [
  ...
  defineProduct({
    ...
    gallery: gallery("/tur/automatic-operators/sliding-doors/escape-route-sliding-door-hm-f-ft/escape-route-sliding-door-hm-f-ft-main.jpg", "/tur/automatic-operators/sliding-doors/heavymaster-hm/heavymaster-hm-main.jpg", "/tur/automatic-operators/sliding-doors/prismatic-sliding-door-cmw/prismatic-sliding-door-cmw-main.png"),
    features: [
  ...
  defineProduct({
    ...
    gallery: gallery("/tur/automatic-operators/sliding-doors/economaster-em/economaster-em-main.jpg", "/tur/automatic-operators/sliding-doors/compactmaster-cm/compactmaster-cm-main.jpg", "/tur/automatic-operators/sliding-doors/prismatic-sliding-door-cmw/prismatic-sliding-door-cmw-main.png"),
    features: [
  ...
  defineProduct({
    ...
    gallery: gallery("/tur/automatic-operators/sliding-doors/compactmaster-cm/compactmaster-cm-main.jpg", "/tur/automatic-operators/sliding-doors/economaster-em/economaster-em-main.jpg", "/tur/automatic-operators/sliding-doors/telescoping-sliding-door-emt/telescoping-sliding-door-emt-main.jpg"),
    features: [
  ...
  defineProduct({
    ...
    gallery: gallery("/tur/automatic-operators/controlled-physical-access/reader-posts-guiding-bar/reader-posts-guiding-bar-main.jpg", "/tur/automatic-operators/controlled-physical-access/turnstile-systems/turnstile-systems-main.jpg", "/tur/automatic-operators/controlled-physical-access/speed-gate-barriers/speed-gate-barriers-main.jpg"),
  ...
  defineProduct({
    ...
    gallery: gallery("/tur/automatic-operators/controlled-physical-access/gsi-curved-sliding-access/gsi-curved-sliding-access-main.jpg", "/tur/automatic-operators/revolving-doors/gsi-security-revolving-door/gsi-security-revolving-door-main.jpg", "/tur/automatic-operators/controlled-physical-access/turnstile-systems/turnstile-systems-main.jpg"),
  ...
  defineProduct({
    ...
    gallery: gallery("/tur/automatic-operators/controlled-physical-access/sensor-barriers/sensor-barriers-main.jpg", "/tur/automatic-operators/controlled-physical-access/speed-gate-barriers/speed-gate-barriers-main.jpg", "/tur/automatic-operators/controlled-physical-access/turnstile-systems/turnstile-systems-main.jpg"),
  ...
  defineProduct({
    ...
    gallery: gallery("/tur/automatic-operators/controlled-physical-access/swing-gates/swing-gates-main.jpg", "/tur/automatic-operators/controlled-physical-access/turnstile-systems/turnstile-systems-main.jpg", "/tur/automatic-operators/controlled-physical-access/sensor-barriers/sensor-barriers-main.jpg"),
  ...
  defineProduct({
    ...
    gallery: gallery("/tur/automatic-operators/controlled-physical-access/tripod-turnstiles/tripod-turnstiles-main.jpg", "/tur/automatic-operators/controlled-physical-access/turnstile-systems/turnstile-systems-main.jpg", "/tur/automatic-operators/controlled-physical-access/full-height-turnstile/full-height-turnstile-main.jpg"),
  ...
  defineProduct({
    ...
    gallery: gallery("/tur/automatic-operators/revolving-doors/ggr-large-capacity-revolving/ggr-large-capacity-revolving-main.jpg", "/tur/automatic-operators/revolving-doors/gra-standard-revolving-door/gra-standard-revolving-door-main.jpg", "/tur/automatic-operators/revolving-doors/ggg-all-glass-revolving-door/ggg-all-glass-revolving-door-main.jpg"),
    features: [
      "Large-diameter wing configuration for higher visitor throughput at scale.",
      "3-wing and 4-wing configurations to suit different capacity and footprint requirements.",
      "Automatic drive with safety sensor integration and obstruction detection.",
      "Suitable for airports, large public buildings and high-throughput transport hubs.",
    ],
    applications: ["Airports and transport hubs", "Large public institutions", "High-traffic commercial buildings", "Major civic entrances"],
    finishOptions: ["3-Wing", "4-Wing"],
    specs: [
      { label: "Diameter", value: "3500 – 6000 mm" },
      { label: "Number of wings", value: "3 or 4" },
      { label: "Clear passage width per wing", value: "up to 2000 mm" },
      { label: "Throughput", value: "High-capacity multi-person passage" },
      { label: "Supply voltage", value: "230V AC, 50Hz" },
    ],
  ...
  defineProduct({
    ...
    gallery: gallery("/tur/automatic-operators/all-glass-systems/shopmaster-gsw-m-g30/shopmaster-gsw-m-g30-main.jpg", "/tur/automatic-operators/all-glass-systems/sliding-doors/sliding-doors-main.jpg", "/tur/automatic-operators/all-glass-systems/shopmaster-gsw-m/shopmaster-gsw-m-main.jpg"),
    features: [
      "G30 glass thickness specification for heavier panel applications.",
      "Frameless all-glass aesthetics for premium architectural entrance expression.",
      "Integrates with access control, safety sensors and building management systems.",
      "Self-learning control system with connection and adjustment options.",
    ],
    applications: ["Premium retail", "Corporate headquarters", "Luxury hospitality arrivals", "High-specification architectural entrances"],
    finishOptions: ["Single Slide", "Bi-Parting"],
    specs: [
      { label: "Application", value: "1-leaf / 2-leaf" },
      { label: "Clear passage width (1-leaf)", value: "700 – 1200 mm" },
      { label: "Clear passage width (2-leaf)", value: "700 – 2400 mm" },
      { label: "Clear passage height", value: "max. 3000 mm" },
      { label: "Glass thickness", value: "10 – 19 mm (G30 specification)" },
      { label: "Door leaf weight", value: "max. 120 kg / leaf" },
      { label: "Supply voltage", value: "230V AC, 50Hz" },
      { label: "Opening speed", value: "max. 0.9 m/s" },
    ],
  ...
  defineProduct({
    ...
    gallery: gallery("/tur/automatic-operators/all-glass-systems/shopmaster-gsw-m/shopmaster-gsw-m-main.jpg", "/tur/automatic-operators/all-glass-systems/shopmaster-gsw-m-g30/shopmaster-gsw-m-g30-main.jpg", "/tur/automatic-operators/all-glass-systems/sliding-doors/sliding-doors-main.jpg"),
    features: [
      "Full frameless glass sliding system for contemporary commercial entrance aesthetics.",
      "Reliable automatic drive with sensor and access control compatibility.",
      "Self-learning control system with connection and adjustment options.",
      "Wide range of commercial, retail and hospitality entrance applications.",
    ],
    applications: ["Commercial offices", "Retail stores", "Hospitality reception areas", "Showrooms and public buildings"],
    finishOptions: ["Single Slide", "Bi-Parting"],
    specs: [
      { label: "Application", value: "1-leaf / 2-leaf" },
      { label: "Clear passage width (1-leaf)", value: "700 – 1200 mm" },
      { label: "Clear passage width (2-leaf)", value: "700 – 2400 mm" },
      { label: "Clear passage height", value: "max. 3000 mm" },
      { label: "Glass thickness", value: "8 – 16 mm" },
      { label: "Door leaf weight", value: "max. 100 kg / leaf" },
      { label: "Supply voltage", value: "230V AC, 50Hz" },
      { label: "Opening speed", value: "max. 0.9 m/s" },
    ],
  ...
  defineProduct({
    ...
    gallery: gallery("/tur/automatic-operators/automatic-pulse-generators-and-sensors/safety-sensors/safety-sensors-main.webp", "/tur/automatic-operators/automatic-pulse-generators-and-sensors/activation-devices-sensors/activation-devices-sensors-main.webp", "/tur/automatic-operators/automatic-pulse-generators-and-sensors/control-inputs/control-inputs-main.jpg"),
  ...
  defineProduct({
    ...
    gallery: gallery("/tur/automatic-operators/automatic-pulse-generators-and-sensors/control-inputs/control-inputs-main.jpg", "/tur/automatic-operators/automatic-pulse-generators-and-sensors/activation-devices-sensors/activation-devices-sensors-main.webp", "/tur/automatic-operators/automatic-pulse-generators-and-sensors/safety-sensors/safety-sensors-main.webp"),
  ...
  defineProduct({
    ...
    category: "European Ironmongery",
    description:
      "TE4100 Series full mortise hinges (SS304, CE Grade 13, BS EN 1935:2002 / BS EN 1634 fire rated, up to 120 kg), TE4160 rising hinges (SS304, up to 80 kg, gravity self-close), TA4600 3D adjustable concealed hinges (TA4630 80 kg / TA4640 120 kg) and TA4400 spring hinges (ANSI A156.17) — the complete European Ironmongery hanging range.",
    shortDescription:
      "TE4100 mortise hinges, TE4160 rising hinges and TA4600 concealed hinges — CE Grade 13, BS EN 1935:2002, fire rated.",
    overview:
      "Hang The Door in the European Ironmongery range covers four hinge families. The TE4100 Series full mortise hinges (TE4110 4×3, TE4120 4×3.5, TE4130 4×4) are made from Stainless Steel 304 with stainless steel ball bearings and imported damping oil — available in 2BB or 4BB configurations, door weight up to 120 kg with 3 hinges, CE certified Grade 13, tested to BS EN 1935:2002 and fire-rated to BS EN 1634. The TE4160 rising hinges are SS304, handed, gravity self-closing, for wood flush doors up to 80 kg. The TA4600 3D adjustable concealed hinges (TA4630 80 kg / TA4640 120 kg) offer continuously adjustable height, side and closing pressure with a flush panel appearance and 180° opening — for wood doors and frames. The TA4400 spring hinges (TA4410 4½×4, TA4420 4½×4½) are certified to ANSI A156.17 in single-action configuration. All models packed with wood and metal screws.",
    image: "/tur/door-hardware/mc-2.jpg",
    imageAlt: "TE4100 full mortise hinge — European ironmongery hanging hardware",
    gallery: gallery("/tur/door-hardware/mc-2.jpg", "/tur/door-hardware/decorative-lever.jpg", "/tur/door-hardware/european-lockset.jpg"),
    features: [
      "TE4100 Series — SS304, 2BB or 4BB ball bearing, door weight up to 120 kg (3 hinges), CE Grade 13, BS EN 1935:2002, BS EN 1634 fire rated.",
      "TE4110 (4×3×3 — 102×76×3mm), TE4120 (4×3.5×3 — 102×89×3mm), TE4130 (4×4×3 — 102×102×3mm).",
      "Hinge tip options: Flat Tip, Button Tip (BT), Hospital Tip (HT). Pin type: Removable Pin (RP) or Non-Removable Pin (NRP). ETW (electric through wire) and PIC (plug-in connector) also available.",
      "TE4160 Rising Hinges — SS304, gravity self-closing, up to 80 kg, handed, for wood flush doors.",
      "TA4600 3D Adjustable Concealed Hinges — zinc alloy body, TA4630 80 kg (28×177mm), TA4640 120 kg (34×246mm); continuously adjustable height, side and closing pressure; 180° opening, concealed installation.",
      "TA4400 Spring Hinges — ANSI A156.17 certified, standard weight, single-action; TA4410 (4½×4 in/114×102mm), TA4420 (4½×4½ in/114×114mm).",
    ],
    applications: [
      "Fire-door sets requiring CE and BS EN 1634 compliant hinges",
      "Premium hospitality guestroom and suite door sets",
      "Executive office and boardroom paired openings",
      "Institutional healthcare doors requiring Grade 13 hang performance",
    ],
    finishOptions: [
      "630 — Satin Stainless Steel (standard)",
      ...
      "606 — Satin Brass",
      "605 — Polished Brass",
      "604 — Satin Brass (TA4600 series)",
      "612 — Satin Bronze (TA4600 series)",
      "613 — Oil Rubbed Bronze (TA4600 series)",
      "619 — Satin Nickel (TA4600 series)",
      "Other finishes available upon request",
    ],
  ...
  defineProduct({
    ...
    category: "European Ironmongery",
    description:
      "TE7640 Project Series rack-and-pinion door closer (standard arm, EN size 2–4, max 1100mm door), TE7xxx track arm closer (EN size 2–5, max 1250mm), TE7904 concealed rack-and-pinion closer (40mm+ door, max 1100mm), TE7768 Premium Series standard arm closer, TE7830 floor spring — all in the European Ironmongery Control The Door range.",
    shortDescription:
      "TE7640, TE7768, TE7904 rack-and-pinion closers and TE7830 floor spring — EN size 2–5, up to 1250mm door width.",
    overview:
      "Control The Door in the European Ironmongery range covers surface-mounted and concealed overhead closers plus a heavy-duty floor spring. The TE7640 Project Series is a rack-and-pinion closer with standard arm — EN size 2/3/4, adjustable closing and latching speed, thermo-constant valve, max door width 1100mm, 180° max opening angle. Available with hold open arm, parallel bracket and cover accessories. The track arm closer (TE7xxx Project Series) uses the same rack-and-pinion mechanism with a track arm — EN size 2–5, max door width 1250mm, available in B type (door mount pull side) and G type (door mount push side), with hold open device, cushion limit stay and angle bracket options. The TE7904 Project Series is a concealed closer installed within the door — EN size 2/3/4, minimum 40mm door thickness (44mm / 54mm fire door), max door width 1100mm, max opening angle 120°. The TE7768 Premium Series is a surface-mounted standard arm closer — EN size 2/3/4, max 1100mm, 180° opening. All closers: non-handed installation, anodized aluminum body, painted silver as standard, thermo-constant valve, adjustable closing and latching speed. The TE7830 is a floor spring for single-action double-action control in premium applications.",
    image: "/tur/door-hardware/product-door-closer.jpg",
    imageAlt: "TE7640 rack-and-pinion door closer — European Ironmongery Control The Door",
    ...
    features: [
      "TE7640 Project Series — standard arm, rack & pinion, EN size 2–4, max 1100mm door, 180° opening, thermo-constant valve.",
      "Track arm closer (Project Series) — rack & pinion, EN size 2–5, max 1250mm door, B and G type mounting configurations.",
      "TE7904 Project Series — concealed in door, rack & pinion, EN size 2–4, min 40mm door, max 1100mm door, 120° opening; also suits 44mm and 54mm fire doors.",
      "TE7768 Premium Series — standard arm, rack & pinion, EN size 2–4, max 1100mm door, 180° opening.",
      "TE7830 Floor Spring — heavy duty single/double action, for premium floor-controlled applications.",
      "All overhead closers: non-handed, anodized aluminum body, painted silver standard, adjustable closing and latching speed.",
      "Accessories available: hold open arm, track arm, parallel bracket, cover, mounting plate, cushion limit stay, angle bracket.",
    ],
    applications: [
      "Premium hospitality and hotel main entrance doors",
      "Executive office suite entrances requiring concealed control",
      "Fire doors requiring controlled self-closing",
      "High-traffic commercial and institutional openings",
    ],
    finishOptions: [
      "Painted Silver (standard — closer body)",
      "Anodized Aluminum (standard — body and track rail for track arm models)",
      "Plating finishes available upon request (for covers only)",
      "Other finishes available upon request",
    ],
  ...
  defineProduct({
    ...
    category: "European Ironmongery",
    description:
      "TE1410 Premium Mortise Sash Lock, TE1420 Premium Privacy Lock, TE1430 Premium Latch Lock and TE1440 Premium Deadbolt Lock — all Stainless Steel 304, CE Certified, BS EN 12209:2003 (200,000 life cycle), BS EN 1634 fire rated, for euro profile cylinder; plus TE1510 Project Series equivalents.",
    shortDescription:
      "TE1410–TE1440 SS304 mortise locks — CE Certified, BS EN 12209:2003, 200,000 cycles, BS EN 1634 fire rated.",
    overview:
      "Secure The Door in the European Ironmongery range covers four Premium Series mortise lock bodies and their Project Series equivalents. The TE1410 Mortise Sash Lock is for fire, smoke lobby and interior door applications — forend, strike, latch, bolt and follower in SS304; uses euro profile cylinder with double-turn deadbolt; 8×8mm follower; optional backset 55/60mm; distance 72/85mm; 20mm forend for rebated or 22/24mm for flush door; non-handed; CE Certified; BS EN 12209:2003 200,000 life cycle; BS EN 1634 fire rated. The TE1420 Privacy Lock uses a thumb turn indicator instead of a cylinder with double-turn deadbolt; backset 55/60mm; distance 78mm; BS EN 12209:2003. The TE1430 Latch Lock is for passage doors — no bolt, latch only; CE Certified; BS EN 12209:2003; fire rated. The TE1440 Deadbolt Lock is for fire and smoke lobby doors — bolt only in SS304; CE Certified; BS EN 12209:2003; fire rated. The TE1510 Mortise Sash Lock is the Project Series equivalent of TE1410 with the same certifications. All models: one lock body, one strike plate, one pocket, one set of fixing screws; Satin Stainless Steel standard; suffix DP for dust-proof sockets.",
    image: "/tur/door-hardware/format-lockset.jpg",
    imageAlt: "TE1410 Premium Mortise Sash Lock — European Ironmongery Secure The Door",
    gallery: gallery("/tur/door-hardware/format-lockset.jpg", "/tur/door-hardware/european-lockset.jpg", "/tur/door-hardware/mc-1.jpg"),
    features: [
      "TE1410 Premium Mortise Sash Lock — SS304 forend/strike/latch/bolt/follower; euro cylinder; CE Certified; BS EN 12209:2003 200,000 cycles; BS EN 1634 fire rated.",
      "TE1420 Premium Privacy Lock — SS304; thumb turn indicator; BS EN 12209:2003 200,000 cycles; backset 55/60mm, distance 78mm.",
      "TE1430 Premium Latch Lock (passage) — SS304; CE Certified; BS EN 12209:2003; BS EN 1634 fire rated.",
      "TE1440 Premium Deadbolt Lock — SS304 bolt; CE Certified; BS EN 12209:2003; BS EN 1634 fire rated; for fire and smoke lobby doors.",
      "TE1510 Project Series Mortise Sash Lock — same certifications as TE1410; CE Certified; BS EN 12209:2003; fire rated.",
      "All models: non-handed, easy direction adjustment on site; backset options 55/60mm; 20mm forend (rebated) or 22/24mm (flush).",
      "Suffix DP available for dust-proof socket versions.",
    ],
    applications: [
      "Fire and smoke lobby doors (TE1410, TE1430, TE1440)",
      "Hospitality guestroom privacy (TE1420)",
      "Commercial and institutional interior secure areas",
      "Executive suites and boardrooms requiring coordinated ironmongery",
    ],
    finishOptions: [
      "630 — Satin Stainless Steel (standard)",
      "Other finishes available upon request",
  ...
  defineProduct({
    ...
    category: "European Ironmongery",
    description:
      "Complete European Ironmongery ancillary range — SS304 door stops (TU.DS series), thumb turn indicators (TU.TT series, 35–45mm door), door guards (TU.DG series), door holders (TU.DH series, with/without magnet), door viewer (TU.DV001, 180°/200°, 35–55mm door), flush handles for sliding doors (TU.FH series), push plates (T8080), flush ring pull handles (TU.CH001), finger pulls (TU.CH004), dust proof strikes (TU.DP series), roller latches (TU8403/TU8404H), sign plates (TU.SP series) and tower bolts (SS304, square/round/oval/flat).",
    shortDescription:
      "SS304 door stops, thumb turns, guards, holders, viewer, flush handles, push plates, bolts and sign plates — complete European ancillary range.",
    overview:
      "Ancillary Products in the European Ironmongery range provides every completion item for a coordinated ironmongery schedule. Door Stops (TU.DS 001, 006, 009, 015, 020, 029, 030, 032, 033, 034): SS304, rubber stopper, reduce noise, applicable to various door types, Satin standard. Thumb Turn Indicators (TU.TT001SS, TU.TT005SS, TU.TT007SS, TU.TT009SS, TU.TT011SS, TU.TT014SS): SS304, for wood doors, door thickness 35–45mm (lengthened spindle available above 45mm), Satin/Polished. Door Guard (TU.DG002, TU.DG004, TU.DG005): SS304, for inward-opening wood doors; cover plate and chain in SS, supplied with frame component and fixing material. Door Holders (TU.DH 003 — with magnet; TU.DH 004, 005 — without magnet; TU.DH 007 — Satin Nickel; TU.DH 008 — with magnet): SS304, Satin standard. Door Viewer (TU.DV001): finest brass with brass trim washer, Satin Stainless Steel, 180° or 200° angle of view, door thickness 35–55mm, recommended installation height 1500mm. Flush Handles for sliding doors (TU.FH 009, 029, 031, 032, 111, 112, 113, 117): SS304, spring construction keeping surface flush, door thickness 35–45mm, Satin/Polished. Push Plates (TU.LH 81A, TU.FH 81B, TU.LH 4608-1, TU.LH 4608-2): SS304, bevelled 4 sides, counter-sunk screws, custom dimensions available, Satin/Polished. Flush Ring Pull Handles (TU.CH 001A, TU.CH 001B): SS304, for well door with shaft lock, Satin. Finger Pulls (TU.CH 004, TU.CH 004A): SS304, for use with flush bolt, Satin. Door Protection Plates (T8080 KP/MP/AP/SP): SS304, 630/629 finish, 6/8/10/12 height, radius or square corners. Dust Proof Strikes (TU.DP001 — dust excluding floor socket; TU.DP002 — easy clean floor socket; TU.DP 410): SS304, screw fixing, for use with flush bolt. Roller Latches (TU8403 heavy duty adjustable; TU8404H with T-strike): surface fixing, 35/42mm. Sign Plates (TU.SP007, SP008, SP009, SP010, SP011): SS304, screw fixing, black graphic, other finishes on request. Tower Bolts (TU.TBS/TBR/TBO/TBRC/TBF series): SS202/304, square, round, oval, rectangle and flat profiles, 3 to 12 inch sizes.",
    image: "/tur/home/project-4.jpg",
    imageAlt: "European ironmongery ancillary products — door stops, thumb turns, viewers and completion accessories",
    gallery: gallery("/tur/home/project-4.jpg", "/tur/door-hardware/mc-2.jpg", "/tur/door-hardware/decorative-lever.jpg"),
    features: [
      "Door Stops (TU.DS series) — SS304, rubber stopper to reduce noise, for various door types.",
      "Thumb Turn Indicators (TU.TT series) — SS304, door thickness 35–45mm, lengthened spindle available above 45mm, Satin/Polished.",
      "Door Guard (TU.DG series) — SS304, for inward-opening wood doors, chain and cover plate.",
      "Door Holders (TU.DH series) — SS304, magnetic (DH 003, DH 008) and non-magnetic (DH 004, DH 005) variants.",
      "Door Viewer (TU.DV001) — brass, 180° or 200° view angle, door thickness 35–55mm, installation height 1500mm.",
      "Flush Handles (TU.FH series) — SS304, for wood sliding doors, spring construction, door thickness 35–45mm, Satin/Polished.",
      "Push Plates (T8080 series) — SS304, bevelled 4 sides, counter-sunk mounting, custom dimensions available.",
      "Flush Ring Pull Handles (TU.CH 001A/B) and Finger Pulls (TU.CH 004/004A) — SS304, for well and flush bolt doors.",
      "Dust Proof Strikes (TU.DP001, DP002, DP 410) — SS304, easy-clean removable plate, screw fixing.",
      "Roller Latches (TU8403, TU8404H) — heavy duty adjustable, 35/42mm backset, surface fixing.",
      "Sign Plates (TU.SP007–SP011) — SS304, black graphic, screw fixing.",
      "Tower Bolts (SS304, 3–12 inch) — square, round, oval, rectangle and flat profiles.",
    ],
    applications: [
      "Premium hospitality and hotel ironmongery packages — door stops, thumb turns, viewers",
      "Fire and paired door sets — flush bolts, dust proof strikes, roller latches",
      "Residential common areas — coat hooks, sign plates, door protection plates",
      "Executive and institutional door sets — complete ancillary schedule",
    ],
    finishOptions: [
      "630 — Satin Stainless Steel (standard for most items)",
      "629 — Polished Stainless Steel (available on most items)",
      "619 — Satin Nickel (TU.DH 007)",
      "Other finishes available upon request",
    ],
  ...
  defineProduct({
    ...
    category: "European Ironmongery",
    description:
      "TE9800 Premium Series exit devices (TE9810 Narrow Stile Rim, TE9820 Narrow SVR, TE9840 Narrow CVR) and TE9700 Project Series (TE9710 Rim, TE9720 SVR, TE9720-LBR, TE9730-MTP, TE9740-CVR) plus TE9010 Commercial Rim — all BS EN 1125 certified, CE marked, fire rated 3 hours, AL & SSS finishes standard.",
    shortDescription:
      "TE9800 Premium and TE9700 Project Series exit devices — BS EN 1125 certified, CE marked, 3-hour fire rated, door width 24\"/36\"/48\".",
    overview:
      "Emergency Exits in the European Ironmongery range covers three series of exit devices. The TE9800 Premium Series offers superior shock resistance and architectural finish options — all inside components are high rust-resistant alloy or heavily electro-plated steel; (A) label rating on pairs of doors up to 8ft x 8ft swinging same or opposite directions; all devices non-handed or reversible; through-bolted trim design for maximum durability. TE9810 (Narrow Stile Rim): non-handed, stainless steel latch bolt 3/4\" throw, dead latch bolt, 1/2 turn hex dogging standard, 800 roller strike, alarm option ALM-2, cylinder dogging CLD-2, door width 24\"/36\"/48\", door thickness 1-3/4\"-2\", min stile 45mm, push bar neutral 67mm / depressed 48mm, mounting height 41\" — certified EN1125 fire rated 3 hours. TE9820 (Narrow Stile SVR): reversible, top latch 3/4\" / bottom latch 1/2\" throw, 720 Top Strike / 730 Bottom Strike, no dead latch, 1/2 turn hex dogging, alarm ALM-2, cylinder dogging CLD-2, same door sizing — EN1125 fire rated 3 hours. TE9840 (Narrow Stile CVR — Concealed Vertical Rod): same specs as TE9820 but concealed rod. The TE9700 Project Series (TE9710 Rim, TE9720 SVR, TE9720-LBR Less Bottom Rod, TE9730-MTP Mortise, TE9740-CVR Concealed Vertical Rod) is certified BS EN 1125 and fire rated 3 hours. The TE9010 Commercial Series Rim is non-handed, 1\" latch throw, 1/2 thumb-turn dogging, 300 rigid strike, CE certified EN 1125, fire rated 3 hours.",
    image: "/tur/home/slider-1.webp",
    imageAlt: "TE9800 Series exit device — BS EN 1125 certified panic bar for European ironmongery",
    gallery: gallery("/tur/home/slider-1.webp", "/tur/door-hardware/format-lockset.jpg", "/tur/door-hardware/mc-1.jpg"),
    features: [
      "TE9810 Narrow Stile Rim (Premium) — non-handed; SS latch ¾\" + dead latch; 800 roller strike; ½ turn hex dogging; alarm ALM-2; CLD-2 cylinder dogging; min stile 45mm; push bar 67mm neutral / 48mm depressed; EN1125 fire rated 3 hours.",
      "TE9820 Narrow Stile SVR (Premium) — reversible; top latch ¾\" / bottom latch ½\"; 720+730 strikes; ½ turn hex dogging; ALM-2 / CLD-2; EN1125 fire rated 3 hours.",
      "TE9840 Narrow Stile CVR (Premium) — reversible; concealed vertical rod; same specs as TE9820; EN1125 fire rated 3 hours.",
      "TE9700 Project Series — TE9710 Rim (non-handed), TE9720 SVR (reversible), TE9720-LBR (less bottom rod), TE9730-MTP (mortise type rim), TE9740-CVR (concealed vertical rod) — all BS EN 1125, fire rated 3 hours.",
      "TE9010 Commercial Rim — non-handed, 1\" latch throw, ½ thumb-turn dogging, 300 rigid strike, CE EN 1125, fire rated 3 hours.",
      "All devices: door width options 24\" / 36\" (standard) / 48\"; door thickness 1¾\"–2\" standard; mounting height 41\" from CL to finished floor.",
      "All devices: (A) label rated on pairs of doors up to 8'×8\"; through-bolted trim design; outside trims via rose and escutcheon lever or knob.",
    ],
    applications: [
      "Commercial fire exit routes and escape corridors",
      "Institutional egress — hospitals, schools, government buildings",
      "Hospitality life-safety exits requiring finish coordination",
      "Retail and mixed-use paired door emergency egress",
    ],
    finishOptions: [
      "AL — Aluminum (standard)",
      "SSS — Satin Stainless Steel (standard)",
      "Other finishes available upon request",
    ],
  ...
  // ── Door Hardware — Access Control: Electric Strikes (European Mortise) ─────
  defineProduct({
    slug: "tu-600-electric-strike",
    ...
    relatedSlugs: ["tu-810-electric-strike", "tu-1296", "tu-1297"],
  }),
  defineProduct({
    slug: "tu-810-electric-strike",
    ...
    relatedSlugs: ["tu-600-electric-strike", "tu-1296", "tu-1297"],
  }),
