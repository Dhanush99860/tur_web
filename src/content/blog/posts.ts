...
export const blogPosts: BlogPost[] = [
  {
    ...
    excerpt:
      "A clear breakdown of master key hierarchy levels â€” from individual keyed-different cylinders through sub-masters, masters and grand masters â€” and how to specify them for hotels, hospitals and campus projects.",
    ...
    body: [
      {
        ...
        paragraphs: [
          "A master key system is a locking hierarchy that allows different keys to open different subsets of doors within a building or campus. Rather than issuing a single key that opens everything â€” a serious security risk â€” or individual keys for every door, a master key scheme creates logical zones of access. Each cylinder in the system is configured during manufacturing so that it responds to its individual key and to one or more higher-level keys in the hierarchy.",
      ...
      },
      {
        ...
        paragraphs: [
          "Keyed Different (KD) is the baseline condition: each cylinder has a unique key that opens only that lock. KD cylinders form the leaves of the hierarchy â€” individual office doors, room doors or storage units that require exclusive access. A housekeeper's key does not open a KD room to which they are not assigned.",
          "Keyed Alike (KA) groups multiple cylinders so they all respond to the same key. This is useful where a single person legitimately needs access to several doors of the same type â€” a maintenance technician servicing all plant rooms on a floor, for example. KA cylinders reduce the key burden without elevating the holder's overall access level.",
          ...
          "Grand Master Key (GMK) sits at the apex of a two-tier hierarchy, opening all cylinders across every sub-group in the building. In large campuses or organisations with multiple buildings, a further tier â€” the Great Grand Master Key (GGMK) â€” can be introduced. The GMK is typically held by facilities management, security directors or senior operations personnel, and its use should be audited wherever possible.",
        ],
      },
      {
        heading: "Sub-Master Keys and Multi-Site Hierarchies",
        paragraphs: [
          "Between the individual MK and the GMK, a Sub-Master Key (SMK) provides an intermediate layer. In a hospital, for instance, an SMK might cover a single department â€” surgical, pharmacy, administration â€” while the GMK covers the entire facility. This intermediate tier means a departmental manager holds meaningful access without needing a GMK.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "When specifying TURN master key systems, TUR recommends including the cylinder specification, the key duplication control protocol and the keying schedule process within the project's security strategy document. This ensures that all stakeholders â€” architect, consultant, main contractor and end client â€” understand their obligations before cylinders are ordered.",
        ],
      },
    ],
  },
  {
    ...
    excerpt:
      "A specifier's guide to choosing between swing door drives, sliding systems and revolving doors â€” covering traffic volume, accessibility compliance, fire rating and GÂ·U product positioning.",
    category: "Specification Guide",
    image: "/tur/home/slider-5.png",
    imageAlt: "GÂ·U automatic door operator installed on a contemporary commercial entrance",
    publishedAt: "2026-04-28",
    readingTimeMin: 5,
    tags: ["Automatic Operators", "GÂ·U", "Commercial", "Specification"],
    body: [
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "GÂ·U swing door drives offer low-energy and full-power variants. Low-energy operators open the door at a controlled, safe speed suitable for pedestrian environments where incidental contact is possible â€” typically specified for accessible entrances and healthcare settings. Full-power operators are reserved for high-traffic or high-wind-load situations where a faster, more assertive opening cycle is needed.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "For commercial and hospitality projects in the Gulf region, the energy argument for revolving doors is particularly compelling. An automatic sliding entrance on a hotel lobby creates a brief but significant air exchange with every activation â€” multiplied across hundreds of activations per day, this represents meaningful cooling load. A revolving door eliminates this entirely.",
          "GÂ·U revolving systems are available in two-, three- and four-wing configurations, with diameters typically ranging from 2,000 mm to 4,500 mm. All revolving entrances must incorporate emergency breakout panels â€” wing sections that fold flat to create a direct egress path â€” which must be coordinated with the fire strategy and tested as part of commissioning. A bypass sliding leaf alongside the revolving door is mandatory for accessible compliance and for low-traffic periods when the revolving system may be parked.",
        ],
      },
    ],
  },
  {
    ...
    excerpt:
      "What SKG 2-star certification means in practice â€” the drill, pick and bump-resistance tests, the relationship to BS EN 1303:2015, and why specifiers should include it in their cylinder schedules.",
    category: "Standards & Certifications",
    image: "/tur/home/slider-6.png",
    imageAlt: "Format lockset on a contemporary door â€” European security hardware",
